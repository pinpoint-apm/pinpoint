...
public class GroupedInterceptor3 implements AroundInterceptor3 {
    ...
    @Override
    public void after(Object target, Object result, Throwable throwable, Object arg0, Object arg1, Object arg2) {
        InterceptorGroupInvocation transaction = group.getCurrentInvocation();
        
        if (transaction.canLeave(policy)) {
            if (after != null) {
                after.after(target, result, throwable, arg0, arg1, arg2);
            }
