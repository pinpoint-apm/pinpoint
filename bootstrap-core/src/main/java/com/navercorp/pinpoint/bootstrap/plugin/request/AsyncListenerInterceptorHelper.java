...
public class AsyncListenerInterceptorHelper {
    private static final ServletAsyncMethodDescriptor SERVLET_ASYNC_METHOD_DESCRIPTOR = new ServletAsyncMethodDescriptor();
    ...
    public AsyncListenerInterceptorHelper(TraceContext traceContext, AsyncContext asyncContext) {
        ...
        traceContext.cacheApi(SERVLET_ASYNC_METHOD_DESCRIPTOR);
    ...
    private void handle(final Throwable throwable, final int statusCode, final MethodDescriptor methodDescriptor) {
        if (isDebug) {
            logger.debug("Handle async listener. throwable={}, statusCode={}, methodDescriptor={}", throwable, statusCode, methodDescriptor);
        }
        ...
        try {
            ...
            if (trace != null) {
                ...
                spanRecorder.recordApi(SERVLET_ASYNC_METHOD_DESCRIPTOR);
            ...
            if (isDebug) {
                logger.debug("Failed handle. asyncContext={}, throwable={}, statusCode={}, methodDescriptor={}", asyncContext, throwable, statusCode, methodDescriptor, e);
            }
        }
    }
}