...
public class ServerRequestRecorder {
    ...
    private void recordParentInfo(final SpanRecorder recorder, final ServerRequestWrapper serverRequestWrapper) {
        final String parentApplicationName = serverRequestWrapper.getParentApplicationName();
        if (parentApplicationName != null) {
            String host = serverRequestWrapper.getHost();
            if (host == null) {
            ...
            final String type = serverRequestWrapper.getParentApplicationType();
