...
public class RequestWrapperReaderTest {
    ...
    public void read() throws Exception {
        ...
        when(samplingFlagServerRequestWrapper.getSamplingFlag()).thenReturn("s0");
        ...
        when(continueServerRequestWrapper.getTransactionId()).thenReturn("avcrawler01.ugedit^1517877953952^1035131");
        when(continueServerRequestWrapper.getParentSpanId()).thenReturn(Long.valueOf(1));
        when(continueServerRequestWrapper.getSpanId()).thenReturn(Long.valueOf(1));
        when(continueServerRequestWrapper.getFlags()).thenReturn(Short.valueOf("1"));
