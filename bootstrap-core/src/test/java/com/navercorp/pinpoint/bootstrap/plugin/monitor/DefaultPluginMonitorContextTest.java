...
public class DefaultPluginMonitorContextTest {
    ...
    public void registerTest1() throws Exception {
        ...
        PluginMonitorRegistry<DataSourcePluginMonitor> dataSourceMonitorRegistry = context.getDataSourceMonitorRegistry();
        int remainingCapacity = dataSourceMonitorRegistry.getCapacity();

        MockDataSourceMonitor[] mockDataSourceMonitors = createMockDataSourceMonitor(dataSourceMonitorRegistry, remainingCapacity);
        Assert.assertEquals(remainingCapacity, dataSourceMonitorRegistry.getPluginMonitorList().size());
        ...
        Assert.assertEquals(0, dataSourceMonitorRegistry.getPluginMonitorList().size());
    ...
    private MockDataSourceMonitor[] createMockDataSourceMonitor(PluginMonitorRegistry<DataSourcePluginMonitor> dataSourceMonitorRegistry, int remainingCapacity) {
    ...
    private void addOverDataSourceMonitor(PluginMonitorRegistry<DataSourcePluginMonitor> dataSourceMonitorRegistry) {
    ...
    private static class MockDataSourceMonitor extends AbstractDataSourcePluginMonitor {
