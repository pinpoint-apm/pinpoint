...
helix.defineRenderer('stacked_line', 'HubbleStackedLineChart', function(){
    var self = this,
        option = this.option,
        data = this.data,
        ...
        getEachData = function(index) {
            ...
            /*
             ...
             each.push(value[index] - each[i-1]);
             }
             }
             } else {
             */
        ...
        _draw : function(keys) {
            ...
            var drawData = function(key) {
                ...
                var area = d3.svg.area()
                    ...
                    .y0(function (d, i) {
                        return top_padding + axis_height - height[i] + .5
                    })
                    .y1(function (d, i) {
                        ret = yScale(d) - height[i] + .5;
