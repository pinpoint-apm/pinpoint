...
var flotControl = {
    ...
    setFlotOptionToDataForLine:function (dataset, color, fillColorAFrom, fillColorATo) {
    ...
    // series(i)
    // fillColorTo: rgba
    setFlotOptionToData:function (dataset, fillParam, color, fillColorAFrom, fillColorATo, lineWidthParam) {
    ...
    setFlotOptionByFactor:function (factorCateName, option) {
        ...
        option.legend.labelFormatter = function (datalabel, series, urgentPrefixToTrim) {
    ...
    showTooltip_OneGraph:function (mousePosXAxisValue, graphUid, boolShowDateTooltip) {
    ...
    showTooltip2:function (toolTipId, x, y, contents, textColor, bgcolor, tooltipClass) {
    ...
    showTooltip:function (toolTipId, x, y, contents, textColor, bgcolor, tooltipClass) {
        removeElement(toolTipId);
        // see flot.css
        // jQuery('<label id="'+toolTipId+'" class="'+tooltipClass+'"><span
        // style="color:'+textColor+';">' + contents + '</span></label>').css( {
    ...
    getPixelXUsingXdataRatioAndMousePosition:function (plotTop, plotLeft, plotWidth, plotHeight, plotXaxis, mousePosXAxisValue) {
    ...
    // ex) ops.write => write
    makeGraphTitleFromDataLabel:function (datalabel, rrdFileName, labelPrefix2Trim) {
    ...
    showDataLabel:function (plotDiv, labelId, x, y, contents, textColor, bgcolor, tooltipClass) {
    ...
    // set color by all zero data and threshhold
    setGraphColorAndCheckDataForSingleLineChart:function (graphUid, flotOptionlocal, dataset) {
    ...
    // set color by all zero data and threshhold
    setGraphColorAndCheckDataForSingleLineChart_sub:function (graphUid, flotOptionlocal, dataset, doCheckThreshhod) {
    ...
    // call.)
    checkAllData:function (flotOptionlocal, dataset, index, thresholdoverArray, thresholdcolorArray, doCheckThreshhod, useThisColor) {
    ...
    checkThresholdColor:function (yValue, thresholdoverSplited, currentThresholdColorIndex) {
