...
pinpointApp.directive('agentInfo', [ 'agentInfoConfig', '$routeParams', '$http', '$timeout', function (cfg, $routeParams, $http, $timeout) {
    return {
        ...
        link: function postLink(scope, element, attrs) {
             ...
             * @param callback
             */
            getAgentStats = function (agent_id, callback) {
...
//                    var url = 'http://10.25.149.249:9996/agents?callback=JSON_CALLBACK&agentId=' + agent_id;
            ...
            refresh = function (interval) {
                ...
                var refresher = $timeout(function doRefresh() {
                    getAgentStats(scope.agent_id, function (data) {
                    ...
                    refresher = $timeout(doRefresh, interval);
                });
