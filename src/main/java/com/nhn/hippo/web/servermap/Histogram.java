...
public class Histogram {
	...
	private long unknownSampleCount = 0;
	...
	public void addUnknownSample(long value) {
		unknownSampleCount += value;
	}

	public Histogram mergeWith(Histogram histogram) {
	...
	public long getUnknownSampleCount() {
		return unknownSampleCount;
	}
