...
public class RequestDataThriftDTO implements org.apache.thrift.TBase<RequestDataThriftDTO, RequestDataThriftDTO._Fields>, java.io.Serializable, Cloneable, Comparable<RequestDataThriftDTO> {
  ...
  public void unsetDataHashCode() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __DATAHASHCODE_ISSET_ID);
  }

  /** Returns true if field dataHashCode is set (has been assigned a value) and false otherwise */
  public boolean isSetDataHashCode() {
    return EncodingUtils.testBit(__isset_bitfield, __DATAHASHCODE_ISSET_ID);
  }

  public void setDataHashCodeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __DATAHASHCODE_ISSET_ID, value);
  }
  ...
  public int compareTo(RequestDataThriftDTO other) {
    ...
    lastComparison = Boolean.valueOf(isSetDataHashCode()).compareTo(other.isSetDataHashCode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDataHashCode()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataHashCode, other.dataHashCode);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDataString()).compareTo(other.isSetDataString());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDataString()) {
