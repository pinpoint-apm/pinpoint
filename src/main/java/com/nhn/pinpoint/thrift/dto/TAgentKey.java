...
public class TAgentKey implements org.apache.thrift.TBase<TAgentKey, TAgentKey._Fields>, java.io.Serializable, Cloneable, Comparable<TAgentKey> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TAgentKey");
  ...
  static {
    schemes.put(StandardScheme.class, new TAgentKeyStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TAgentKeyTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TAgentKey.class, metaDataMap);
  }
   ...
   */
  public TAgentKey(TAgentKey other) {
  ...
  public TAgentKey deepCopy() {
    return new TAgentKey(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TAgentKey)
      return this.equals((TAgentKey)that);
    return false;
  }

  public boolean equals(TAgentKey that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TAgentKey other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TAgentKey(");
    boolean first = true;
  ...
  private static class TAgentKeyStandardSchemeFactory implements SchemeFactory {
    public TAgentKeyStandardScheme getScheme() {
      return new TAgentKeyStandardScheme();
    }
  }

  private static class TAgentKeyStandardScheme extends StandardScheme<TAgentKey> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TAgentKey struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAgentKey struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TAgentKeyTupleSchemeFactory implements SchemeFactory {
    public TAgentKeyTupleScheme getScheme() {
      return new TAgentKeyTupleScheme();
    }
  }

  private static class TAgentKeyTupleScheme extends TupleScheme<TAgentKey> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TAgentKey struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TAgentKey struct) throws org.apache.thrift.TException {
