...
public class StatWithCmsCollector implements org.apache.thrift.TBase<StatWithCmsCollector, StatWithCmsCollector._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(StatWithCmsCollector other) {
    ...
    StatWithCmsCollector typedOther = (StatWithCmsCollector)other;
    ...
    lastComparison = Boolean.valueOf(isSetJvmMemoryTotalInit()).compareTo(typedOther.isSetJvmMemoryTotalInit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmMemoryTotalInit()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmMemoryTotalInit, typedOther.jvmMemoryTotalInit);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetJvmMemoryTotalCommitted()).compareTo(typedOther.isSetJvmMemoryTotalCommitted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmMemoryTotalCommitted()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmMemoryTotalCommitted, typedOther.jvmMemoryTotalCommitted);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetJvmGcParNewCount()).compareTo(typedOther.isSetJvmGcParNewCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmGcParNewCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmGcParNewCount, typedOther.jvmGcParNewCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetJvmGcParNewTime()).compareTo(typedOther.isSetJvmGcParNewTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmGcParNewTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmGcParNewTime, typedOther.jvmGcParNewTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetJvmGcCmsCount()).compareTo(typedOther.isSetJvmGcCmsCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmGcCmsCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmGcCmsCount, typedOther.jvmGcCmsCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetJvmGcTime()).compareTo(typedOther.isSetJvmGcTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmGcTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jvmGcTime, typedOther.jvmGcTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
