...
public abstract class AbstractModifier implements Modifier {
    ...
    public boolean findClass(ClassPool classPool, String javassistClassName) {
        // TODO 원래는 get인데. find는 ctclas를 생성하지 않아 변경. 어차피 아래서 생성하기는 함. 유효성 여부 확인 필요
    ...
    private void loadClassLoaderLibraries(ClassPool classPool, ClassLoader classLoader) {
        if (classLoader instanceof URLClassLoader) {
            ...
            // TODO classLoader가 가지고 있는 전체 리소스를 모두 로드해야 되는것인지? 테스트 케이스 만들어서 확인해봐야 할듯.
            ...
            for (URL tempURL : urlList) {
                ...
                try {
                    ...
                    // TODO 여기서 로그로 class로더를 찍어보면 어떤 clasdLoader에서 로딩되는지 알수 있을거 것같음.
