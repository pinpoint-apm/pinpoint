...
import static com.navercorp.pinpoint.common.timeseries.window.TimeWindowSlotCentricSampler.DEFAULT_IDEAL_NUM_TIMESLOTS;
import static com.navercorp.pinpoint.common.timeseries.window.TimeWindowSlotCentricSampler.DEFAULT_MINIMUM_TIMESLOT;
...
public class TimeWindowSlotCentricSamplerTest {
    ...
    public void getWindowSizeFor_1_second() {
        ...
        // When
        final long idealWindowSize = sampler.getWindowSize(range.durationMillis());
        // Then
