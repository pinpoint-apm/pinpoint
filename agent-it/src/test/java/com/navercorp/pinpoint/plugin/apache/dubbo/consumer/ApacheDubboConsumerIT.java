...
package com.navercorp.pinpoint.plugin.apache.dubbo.consumer;
...
@Dependency({"org.apache.dubbo:dubbo:2.7.0", "org.mockito:mockito-all:1.8.4"})
public class ApacheDubboConsumerIT {
