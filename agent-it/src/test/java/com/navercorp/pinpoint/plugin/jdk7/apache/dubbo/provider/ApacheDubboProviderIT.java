...
package com.navercorp.pinpoint.plugin.jdk7.apache.dubbo.provider;
...
@Dependency({"org.apache.dubbo:dubbo:[2.7.x,]", "org.mockito:mockito-all:1.8.4"})
@TraceObjectManagable
public class ApacheDubboProviderIT {
