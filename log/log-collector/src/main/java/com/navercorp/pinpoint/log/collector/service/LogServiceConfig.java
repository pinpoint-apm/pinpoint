...
public class LogServiceConfig {
    ...
    LogAcceptorRepository logAcceptorRepository() {
        return new LogAcceptorRepository();
    }

    @Bean
    LogConsumerRepository logConsumerRepository() {
        return new LogConsumerRepository();
    }
    ...
    LogProviderService logProviderService(
        ...
        return new LogProviderServiceImpl(acceptorRepository, consumerRepository);
    }
