...
~~~
$ java -jar -javaagent:pinpoint-agent-2.1.0/pinpoint-bootstrap-2.1.1.jar -Dpinpoint.agentId=test-agent -Dpinpoint.applicationName=TESTAPP pinpoint-quickstart-testapp-2.1.1.jar
~~~
...
~~~
$ cd ../../
$ java -jar -javaagent:agent/target/pinpoint-agent-2.1.0/pinpoint-bootstrap-2.1.1.jar -Dpinpoint.agentId=test-agent -Dpinpoint.applicationName=TESTAPP quickstart/testapp/target/pinpoint-quickstart-testapp-2.1.1.jar
~~~
