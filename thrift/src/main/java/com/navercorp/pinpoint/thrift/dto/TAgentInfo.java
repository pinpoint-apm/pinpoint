...
public class TAgentInfo implements org.apache.thrift.TBase<TAgentInfo, TAgentInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TAgentInfo> {
  ...
  private @org.apache.thrift.annotation.Nullable java.lang.String ip; // required
  private @org.apache.thrift.annotation.Nullable java.lang.String ports; // required
  ...
  private @org.apache.thrift.annotation.Nullable java.lang.String agentVersion; // required
  private @org.apache.thrift.annotation.Nullable java.lang.String vmVersion; // required
  private long startTimestamp; // required
  private long endTimestamp; // optional
  private int endStatus; // optional
  private @org.apache.thrift.annotation.Nullable TServerMetaData serverMetaData; // optional
  private @org.apache.thrift.annotation.Nullable TJvmInfo jvmInfo; // optional
  private boolean container; // optional
  private @org.apache.thrift.annotation.Nullable java.lang.String agentName; // optional
  ...
  public void setIp(@org.apache.thrift.annotation.Nullable java.lang.String ip) {
    this.ip = ip;
  }
  ...
  public void setPorts(@org.apache.thrift.annotation.Nullable java.lang.String ports) {
    this.ports = ports;
  }
  ...
  public void setServerMetaData(@org.apache.thrift.annotation.Nullable TServerMetaData serverMetaData) {
  ...
  public void setJvmInfo(@org.apache.thrift.annotation.Nullable TJvmInfo jvmInfo) {
  ...
  public void setAgentName(@org.apache.thrift.annotation.Nullable java.lang.String agentName) {
  ...
  public int compareTo(TAgentInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPorts(), other.isSetPorts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPorts()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAgentVersion(), other.isSetAgentVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAgentVersion()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetEndStatus(), other.isSetEndStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEndStatus()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetServerMetaData(), other.isSetServerMetaData());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetServerMetaData()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetJvmInfo(), other.isSetJvmInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmInfo()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetContainer(), other.isSetContainer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetContainer()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAgentName(), other.isSetAgentName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAgentName()) {
