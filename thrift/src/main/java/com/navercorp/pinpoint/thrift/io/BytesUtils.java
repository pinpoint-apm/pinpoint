...
final class BytesUtils {
    ...
    public static byte[] toBytes(final String value) {
        ...
        try {
            return value.getBytes(UTF_8_NAME);
    ...
    public static String toString(final byte [] bytes, final int offset, final int length) {
        ...
        try {
            return new String(bytes, offset, length, UTF_8_NAME);
        } catch (UnsupportedEncodingException e) {
    ...
    public static byte readByte1ForShort(final short value) {
        return (byte) (value >> 8);
    }

    public static byte readByte2ForShort(final short value) {
        return (byte) (value);
    }
}
