...
public class TFTotalThreadCount implements org.apache.thrift.TBase<TFTotalThreadCount, TFTotalThreadCount._Fields>, java.io.Serializable, Cloneable, Comparable<TFTotalThreadCount> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFTotalThreadCount");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFTotalThreadCountStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFTotalThreadCountTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFTotalThreadCount.class, metaDataMap);
  }

  public TFTotalThreadCount() {
  }
   ...
   */
  public TFTotalThreadCount(TFTotalThreadCount other) {
    __isset_bitfield = other.__isset_bitfield;
    this.totalThreadCount = other.totalThreadCount;
  }

  public TFTotalThreadCount deepCopy() {
    return new TFTotalThreadCount(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TFTotalThreadCount)
      return this.equals((TFTotalThreadCount)that);
    return false;
  }

  public boolean equals(TFTotalThreadCount that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TFTotalThreadCount other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFTotalThreadCount(");
    boolean first = true;
  ...
  private static class TFTotalThreadCountStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFTotalThreadCountStandardScheme getScheme() {
      return new TFTotalThreadCountStandardScheme();
    }
  }

  private static class TFTotalThreadCountStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFTotalThreadCount> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFTotalThreadCount struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFTotalThreadCount struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TFTotalThreadCountTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFTotalThreadCountTupleScheme getScheme() {
      return new TFTotalThreadCountTupleScheme();
    }
  }

  private static class TFTotalThreadCountTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFTotalThreadCount> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFTotalThreadCount struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFTotalThreadCount struct) throws org.apache.thrift.TException {
