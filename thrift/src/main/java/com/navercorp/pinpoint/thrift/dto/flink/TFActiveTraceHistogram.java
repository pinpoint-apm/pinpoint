...
public class TFActiveTraceHistogram implements org.apache.thrift.TBase<TFActiveTraceHistogram, TFActiveTraceHistogram._Fields>, java.io.Serializable, Cloneable, Comparable<TFActiveTraceHistogram> {
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> activeTraceCount; // optional
  ...
  public void setActiveTraceCount(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> activeTraceCount) {
  ...
  public int compareTo(TFActiveTraceHistogram other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetActiveTraceCount(), other.isSetActiveTraceCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetActiveTraceCount()) {
