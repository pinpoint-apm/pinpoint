...
public class TCommandTransferResponse implements org.apache.thrift.TBase<TCommandTransferResponse, TCommandTransferResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TCommandTransferResponse> {
  ...
  private @org.apache.thrift.annotation.Nullable TRouteResult routeResult; // required
   ...
   * @see TRouteResult
   */
  public void setRouteResult(@org.apache.thrift.annotation.Nullable TRouteResult routeResult) {
    this.routeResult = routeResult;
  }
  ...
  public int compareTo(TCommandTransferResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRouteResult(), other.isSetRouteResult());
    if (lastComparison != 0) {
