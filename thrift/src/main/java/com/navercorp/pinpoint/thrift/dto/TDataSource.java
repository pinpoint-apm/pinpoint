...
public class TDataSource implements org.apache.thrift.TBase<TDataSource, TDataSource._Fields>, java.io.Serializable, Cloneable, Comparable<TDataSource> {
  ...
  private int activeConnectionSize; // required
  ...
  private static final _Fields optionals[] = {_Fields.SERVICE_TYPE_CODE,_Fields.NAME,_Fields.URL,_Fields.MAX_CONNECTION_SIZE};
  ...
  static {
    ...
    tmpMap.put(_Fields.URL, new org.apache.thrift.meta_data.FieldMetaData("url", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.ACTIVE_CONNECTION_SIZE, new org.apache.thrift.meta_data.FieldMetaData("activeConnectionSize", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public void clear() {
    ...
    this.name = null;
    this.url = null;
    setActiveConnectionSizeIsSet(false);
  ...
  public boolean equals(TDataSource that) {
    ...
    boolean this_present_activeConnectionSize = true;
    boolean that_present_activeConnectionSize = true;
  ...
  public int hashCode() {
    ...
    boolean present_activeConnectionSize = true;
