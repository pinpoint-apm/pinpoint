...
public class FieldDescriptor {
    ...
    private final Class<? extends CustomMetric> type;

    public FieldDescriptor(int index, String name, Class<? extends CustomMetric> type) {
        this.index = index;
        this.name = name;
        this.type = type;
    }
    ...
    public Class<? extends CustomMetric> getType() {
        return type;
    }
