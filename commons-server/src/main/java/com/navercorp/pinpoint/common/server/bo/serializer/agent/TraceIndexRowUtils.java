...
public class TraceIndexRowUtils {
    ...
    public static long extractTimestamp(Cell last) {
        byte[] rowArray = last.getRowArray();
        int rowOffset = last.getRowOffset();
        int timestampOffset = rowOffset + HbaseTableConstants.TRACE_INDEX_SALT_KEY_SIZE + HbaseTableConstants.TRACE_INDEX_TIMESTAMP_OFFSET;
