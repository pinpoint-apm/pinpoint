...
public class JoinContainerBo implements JoinStatBo {
    ...
    private JoinLongFieldBo userCpuUsageJoinValue = JoinLongFieldBo.UNCOLLECTED_FIELD_BO;
    private JoinLongFieldBo systemCpuUsageJoinValue = JoinLongFieldBo.UNCOLLECTED_FIELD_BO;
    private JoinLongFieldBo memoryUsageJoinValue = JoinLongFieldBo.UNCOLLECTED_FIELD_BO;

    public JoinContainerBo(){
    }

    public JoinContainerBo(String id, long avgUserCpuUsage, long maxUserCpuUsage, String maxUserCpuUsageAgentId, long minUserCpuUsage, String minUserCpuUsageAgentId
            ...
            , long timestamp) {
        this(id,
                new JoinLongFieldBo(avgUserCpuUsage, minUserCpuUsage, minUserCpuUsageAgentId, maxUserCpuUsage, maxUserCpuUsageAgentId),
                new JoinLongFieldBo(avgSystemCpuUsage, minSystemCpuUsage, minSystemCpuUsageAgentId, maxSystemCpuUsage, maxSystemCpuUsageAgentId),
                new JoinLongFieldBo(avgMemoryUsage, minMemoryUsage, minMemoryUsageAgentId, maxMemoryUsage, maxMemoryUsageAgentId), timestamp);
    }

    public JoinContainerBo(String id, JoinLongFieldBo userCpuUsageJoinValue, JoinLongFieldBo systemCpuUsageJoinValue,
    ...
    public static JoinContainerBo joinContainerBoList(List<JoinContainerBo> joinContainerBoList, Long timestamp) {
        int boCount = joinContainerBoList.size();
        if (boCount == 0) {
            return EMPTY_JOIN_CONTAINER_BO;
        }

        List<JoinLongFieldBo> userCpuUsageFieldBoList = joinContainerBoList.stream().map(e -> e.getUserCpuUsageJoinValue()).collect(Collectors.toList());
        JoinLongFieldBo userCpuUsageJoinValue = JoinLongFieldBo.merge(userCpuUsageFieldBoList);

        List<JoinLongFieldBo> systemCpuUsageFieldBoList = joinContainerBoList.stream().map(e -> e.getSystemCpuUsageJoinValue()).collect(Collectors.toList());
        JoinLongFieldBo systemCpuUsageJoinValue = JoinLongFieldBo.merge(systemCpuUsageFieldBoList);
    ...
    public JoinLongFieldBo getUserCpuUsageJoinValue(){
        return userCpuUsageJoinValue;
    }

    public void setUserCpuUsageJoinValue(JoinLongFieldBo userCpuUsageJoinValue){
        this.userCpuUsageJoinValue = userCpuUsageJoinValue;
    }

    public JoinLongFieldBo getSystemCpuUsageJoinValue(){
        return systemCpuUsageJoinValue;
    }

    public void setSystemCpuUsageJoinValue(JoinLongFieldBo systemCpuUsageJoinValue){
