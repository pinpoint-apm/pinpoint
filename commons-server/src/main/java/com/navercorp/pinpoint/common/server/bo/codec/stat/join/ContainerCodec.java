...
public class ContainerCodec implements ApplicationStatCodec {
    ...
    public void encodeValues(Buffer valueBuffer, List<JoinStatBo> joinContainerBoList) {
        ...
        JoinLongFieldStrategyAnalyzer.Builder memoryMaxAnalyzerBuilder = new JoinLongFieldStrategyAnalyzer.Builder();
        ...
        for (JoinStatBo joinStatBo : joinContainerBoList) {
            ...
            userCpuUsageAnalyzerBuilder.addValue(joinContainerBo.getUserCpuUsageJoinValue().toLongFieldBo());
            systemCpuUsageAnalyzerBuilder.addValue(joinContainerBo.getSystemCpuUsageJoinValue().toLongFieldBo());
            memoryMaxAnalyzerBuilder.addValue(joinContainerBo.getMemoryMaxJoinValue());
        ...
        encodeDataPoints(valueBuffer
                ...
                , memoryMaxAnalyzerBuilder.build()
    ...
    private void encodeDataPoints(Buffer valueBuffer
            ...
            , JoinLongFieldStrategyAnalyzer memoryMaxAnalyzer
        ...
        codes = memoryMaxAnalyzer.getBestStrategy().getCodes();
        for (byte code : codes) {
            headerEncoder.addCode(code);
        }
        ...
        this.codec.encodeValues(valueBuffer, memoryMaxAnalyzer.getBestStrategy(), memoryMaxAnalyzer.getValues());
    ...
    public List<JoinStatBo> decodeValues(Buffer valueBuffer, ApplicationStatDecodingContext decodingContext) {
        ...
        JoinLongFieldEncodingStrategy memoryMaxEncodingStrategy = JoinLongFieldEncodingStrategy.getFromCode(headerDecoder.getCode(), headerDecoder.getCode(), headerDecoder.getCode(), headerDecoder.getCode(), headerDecoder.getCode());
        ...
        List<JoinLongFieldBo> memoryMaxList = this.codec.decodeValues(valueBuffer, memoryMaxEncodingStrategy, numValues);
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            joinContainerBo.setUserCpuUsageJoinValue(userCpuUsageList.get(i).toDoubleFieldBo());
            joinContainerBo.setSystemCpuUsageJoinValue(systemCpuUsageList.get(i).toDoubleFieldBo());
            joinContainerBo.setMemoryMaxJoinValue(memoryMaxList.get(i));
