...
public class ResponseTimeDecoder extends ApplicationStatDecoder<JoinResponseTimeBo> {

    public ResponseTimeDecoder(List<ApplicationStatCodec<JoinResponseTimeBo>> responseTimeCodecs) {
