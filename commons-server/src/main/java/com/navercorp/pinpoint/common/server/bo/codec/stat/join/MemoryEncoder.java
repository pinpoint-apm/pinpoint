 ...
 * @author minwoo.jung
 */
public class MemoryEncoder extends ApplicationStatEncoder<JoinMemoryBo> {

    private MemoryEncoder(@Qualifier("joinMemoryCodec") ApplicationStatCodec<JoinMemoryBo> memoryCodec) {
        super(memoryCodec);
    }
}
