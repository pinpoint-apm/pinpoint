 ...
 */
@Component
public class ServiceIdInverseMapper implements RowMapper<ServiceId> {

    private static final HbaseColumnFamily.ApplicationId DESCRIPTOR = HbaseColumnFamily.APPLICATION_ID_INVERSE;

    @Override
    public ServiceId mapRow(Result result, int rowNum) throws Exception {
        ...
        UUID serviceIdValue = BytesUtils.bytesToUUID(cell.getValueArray(), cell.getValueOffset());
        return ServiceId.of(serviceIdValue);
    }
