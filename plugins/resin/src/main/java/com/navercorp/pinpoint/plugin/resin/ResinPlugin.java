...
public class ResinPlugin implements ProfilerPlugin, TransformTemplateAware {
    ...
    private void addTransformers() {
        transformTemplate.transform("com.caucho.server.webapp.WebAppFilterChain", new TransformCallback() {
            public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
                ...
                target.getDeclaredMethod("doFilter", "javax.servlet.ServletRequest", "javax.servlet.ServletResponse")
