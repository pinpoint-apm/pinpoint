...
public final class OkHttpConstants {
    ...
    public static final String CONNECTION_GETTER_V2 = "com.navercorp.pinpoint.plugin.okhttp.v2.ConnectionGetter";
    ...
    public static final String USER_REQUEST_GETTER_V2 = "com.navercorp.pinpoint.plugin.okhttp.v2.UserRequestGetter";
    public static final String USER_REQUEST_GETTER_V3 = "com.navercorp.pinpoint.plugin.okhttp.v3.UserRequestGetter";
    public static final String USER_RESPONSE_GETTER_V2 = "com.navercorp.pinpoint.plugin.okhttp.v2.UserResponseGetter";
    public static final String USER_RESPONSE_GETTER_V3 = "com.navercorp.pinpoint.plugin.okhttp.v3.UserResponseGetter";
}
