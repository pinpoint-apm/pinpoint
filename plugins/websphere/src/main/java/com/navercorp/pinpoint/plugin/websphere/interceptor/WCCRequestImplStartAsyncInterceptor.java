    ...
    public void after(Object target, Object[] args, Object result, Throwable throwable) {
        ...
        try {
            ...
            if (validate(target, result, throwable)) {
                ...
                // Set attribute for Servlet 3.0 flag
                request.setAttribute(WebsphereConstants.WEBSPHERE_SERVLET_START_ASYNC, Boolean.TRUE);
                if (isDebug) {
                    logger.debug("Set request attribute. {}={}", WebsphereConstants.WEBSPHERE_SERVLET_START_ASYNC, Boolean.TRUE);
                }
