...
public class WebsphereAsyncListener implements AsyncListener {
    ...
    private int getStatusCode(final AsyncEvent asyncEvent) {
        try {
            ...
            } else if (asyncEvent.getAsyncContext() != null && asyncEvent.getAsyncContext().getResponse() instanceof SRTServletResponse) {
                return ((SRTServletResponse) asyncEvent.getAsyncContext().getResponse()).getStatusCode();
            }
