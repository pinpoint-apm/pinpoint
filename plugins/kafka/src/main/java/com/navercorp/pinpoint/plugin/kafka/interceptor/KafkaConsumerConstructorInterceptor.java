...
public class KafkaConsumerConstructorInterceptor implements AroundInterceptor {

    public KafkaConsumerConstructorInterceptor(TraceContext traceContext, MethodDescriptor descriptor) {
