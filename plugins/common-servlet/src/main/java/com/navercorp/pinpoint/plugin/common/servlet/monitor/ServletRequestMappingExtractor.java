 ...
 * @author Taejin Koo
 */
public interface ServletRequestMappingExtractor extends RequestUrlMappingExtractor<HttpServletRequest> {

    RequestUrlMappingExtractorType TYPE = RequestUrlMappingExtractorType.SERVLET_REQUEST_ATTRIBUTE;
