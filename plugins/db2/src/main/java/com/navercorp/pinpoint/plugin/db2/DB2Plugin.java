...
public class DB2Plugin implements ProfilerPlugin, TransformTemplateAware {
	
	private static final String DB2_SCOPE = DB2PluginConstants.DB2_SCOPE;
    ...
    public void setup(ProfilerPluginSetupContext context) {
    	DB2Config config = new DB2Config(context.getConfig());
    ...
    private void addConnectionTransformer() {
    	logger.info(">>>>>>>>>>>>>>>>>>>>>> IN SIDE addConnectionTransformer");
    ...
    public static class DB2ConnectionTransform implements TransformCallback {
        ...
        public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
            ...
            DB2Config config = new DB2Config(instrumentor.getProfilerConfig());
    ...
    private void addDriverTransformer() {
    	logger.info(">>>>>>>>>>>>>>>>>>>>>> IN SIDE addDriverTransformer");
    ...
    public static class DriverTransformer implements TransformCallback {
        ...
        public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
            ...
            InstrumentUtils.findMethod(	target, 
            							"connect", 
            							"java.lang.String", 
            							"java.util.Properties").addScopedInterceptor(DriverConnectInterceptorV2.class, va(DB2PluginConstants.DB2, true), DB2_SCOPE, ExecutionPolicy.ALWAYS);
    ...
    private void addPreparedStatementTransformer() {
    	logger.info(">>>>>>>>>>>>>>>>>>>>>> IN SIDE addPreparedStatementTransformer");    	
    ...
    private void addStatementTransformer() {
    	logger.info(">>>>>>>>>>>>>>>>>>>>>> IN SIDE addStatementTransformer");    	
    ...
    private void addCallableStatementTransformer() {
    	logger.info(">>>>>>>>>>>>>>>>>>>>>> IN SIDE addCallableStatementTransformer");    	
