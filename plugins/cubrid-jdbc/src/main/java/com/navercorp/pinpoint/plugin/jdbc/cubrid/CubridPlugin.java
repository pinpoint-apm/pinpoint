...
public class CubridPlugin implements ProfilerPlugin, TransformTemplateAware {
    ...
    private final JdbcUrlParser jdbcUrlParser = new CubridJdbcUrlParser();
    ...
    private void addCUBRIDDriverTransformer() {
        transformTemplate.transform("cubrid.jdbc.driver.CUBRIDDriver", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                target.addScopedInterceptor("com.navercorp.pinpoint.bootstrap.plugin.jdbc.interceptor.DriverConnectInterceptor", va(jdbcUrlParser), CubridConstants.CUBRID_SCOPE, ExecutionPolicy.ALWAYS);
