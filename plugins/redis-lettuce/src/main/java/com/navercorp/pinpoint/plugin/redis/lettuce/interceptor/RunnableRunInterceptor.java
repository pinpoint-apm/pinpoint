...
public class RunnableRunInterceptor extends AsyncContextSpanEventSimpleAroundInterceptor {

    public RunnableRunInterceptor(TraceContext traceContext, MethodDescriptor descriptor) {
