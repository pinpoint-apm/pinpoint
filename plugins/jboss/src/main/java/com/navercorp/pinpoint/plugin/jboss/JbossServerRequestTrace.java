 ...
 * @author jaehong.kim
 */
public class JbossServerRequestTrace implements ServerRequestTrace {
    private final HttpServletRequest request;
    private final RemoteAddressResolver<HttpServletRequest> remoteAddressResolver;

    public JbossServerRequestTrace(final HttpServletRequest request, final RemoteAddressResolver<HttpServletRequest> remoteAddressResolver) {
