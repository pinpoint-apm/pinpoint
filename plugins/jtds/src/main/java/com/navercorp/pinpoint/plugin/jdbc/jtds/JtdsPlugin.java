...
public class JtdsPlugin implements ProfilerPlugin, TransformTemplateAware {
    ...
    private final JdbcUrlParser jdbcUrlParser = new JtdsJdbcUrlParser();
    ...
    private void addDriverTransformer() {
        transformTemplate.transform("net.sourceforge.jtds.jdbc.Driver", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                target.addScopedInterceptor("com.navercorp.pinpoint.bootstrap.plugin.jdbc.interceptor.DriverConnectInterceptor", va(jdbcUrlParser), JtdsConstants.JTDS_SCOPE, ExecutionPolicy.ALWAYS);
