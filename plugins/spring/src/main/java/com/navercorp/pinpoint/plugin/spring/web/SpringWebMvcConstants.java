...
public final class SpringWebMvcConstants {
    ...
    public static final String[] SPRING_MVC_URI_MAPPING_ATTRIBUTE_KEYS = {"com.navercorp.pinpoint.plugin.tomcat.interceptor.RequestSetAttributeInterceptor.bestMatchingPattern", "org.springframework.web.servlet.HandlerMapping.bestMatchingPattern"};
