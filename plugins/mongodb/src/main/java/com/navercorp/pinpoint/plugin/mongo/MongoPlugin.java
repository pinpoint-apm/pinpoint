...
public class MongoPlugin implements ProfilerPlugin, TransformTemplateAware {
	...
	public void setup(ProfilerPluginSetupContext context) {
		...
		addSessionTransformer2_X(config);
	...
	private void addConnectionTransformer2_X() {
		transformTemplate.transform("com.mongodb.Mongo", new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				connect.addScopedInterceptor(
						"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoDriverConnectInterceptor2_X", MONGO_SCOPE,
		...
		transformTemplate.transform("com.mongodb.DB", new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				/*InstrumentMethod getReadPreference = InstrumentUtils.findMethod(target, "withReadPreference",
						"com.mongodb.ReadPreference");
				getReadPreference.addScopedInterceptor(
						"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoReadPreferenceInterceptor", MONGO_SCOPE,
						ExecutionPolicy.BOUNDARY);

				InstrumentMethod getWriteConcern = InstrumentUtils.findMethod(target, "withWriteConcern",
						"com.mongodb.WriteConcern");
				getWriteConcern.addScopedInterceptor(
						"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoWriteConcernInterceptor", MONGO_SCOPE,
						ExecutionPolicy.BOUNDARY);*/
	...
	private void addConnectionTransformer3_0_X() {
		...
		transformTemplate.transform("com.mongodb.Mongo", new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				connect.addScopedInterceptor(
						"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoDriverConnectInterceptor3_0", MONGO_SCOPE,
						ExecutionPolicy.BOUNDARY);
	...
	private void addConnectionTransformer3_7_X() {
		...
		transformTemplate.transform("com.mongodb.client.MongoClients", new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				InstrumentMethod connect = InstrumentUtils.findMethod(target, "create",
						"com.mongodb.MongoClientSettings", "com.mongodb.MongoDriverInformation");

				connect.addScopedInterceptor(
						"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoDriverConnectInterceptor3_7", MONGO_SCOPE,
						ExecutionPolicy.BOUNDARY);
		...
		TransformCallback transformCallback = new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				for (InstrumentMethod method : target.getDeclaredMethods(MethodFilters
						.chain(MethodFilters.modifier(Modifier.PUBLIC), MethodFilters.name(getMethodlistR3_0_x())))) {
					method.addScopedInterceptor(
							"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoRSessionInterceptor",
							va(config.isCollectJson(), config.istraceBsonBindValue()), MONGO_SCOPE,
							ExecutionPolicy.BOUNDARY);
				}

				for (InstrumentMethod method : target.getDeclaredMethods(MethodFilters
						.chain(MethodFilters.modifier(Modifier.PUBLIC), MethodFilters.name(getMethodlistCUD3_0_x())))) {
					method.addScopedInterceptor(
							"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoCUDSessionInterceptor",
							va(config.isCollectJson(), config.istraceBsonBindValue()), MONGO_SCOPE,
							ExecutionPolicy.BOUNDARY);
				}
	...
	private void addSessionTransformer2_X(final MongoConfig config) {
		TransformCallback transformCallback = new TransformCallback() {
	...
	private void addSessionTransformer3_7_X(final MongoConfig config) {
		TransformCallback transformCallback = new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				for (InstrumentMethod method : target.getDeclaredMethods(MethodFilters
						.chain(MethodFilters.modifier(Modifier.PUBLIC), MethodFilters.name(getMethodlistR3_7_x())))) {
					method.addScopedInterceptor(
							"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoRSessionInterceptor",
							va(config.isCollectJson(), config.istraceBsonBindValue()), MONGO_SCOPE,
							ExecutionPolicy.BOUNDARY);
				...
				for (InstrumentMethod method : target.getDeclaredMethods(MethodFilters
						.chain(MethodFilters.modifier(Modifier.PUBLIC), MethodFilters.name(getMethodlistCUD3_7_x())))) {
					method.addScopedInterceptor(
							"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoCUDSessionInterceptor",
							va(config.isCollectJson(), config.istraceBsonBindValue()), MONGO_SCOPE,
							ExecutionPolicy.BOUNDARY);
	...
	private void addFilterTransformer() {
		...
		TransformCallback transformCallback = new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				List<InstrumentClass> nestedClasses = target
						.getNestedClasses(ClassFilters.name(MongoConstants.FILTERLIST.toArray(new String[0])));
					...
					if (nestedClass.getName().equals(MongoConstants.MONGO_FILTER_GEOMETRYOPERATOR)) {
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								final InstrumentClass nestedTarget = instrumentor.getInstrumentClass(loader, className,
										classfileBuffer);
								if (!nestedTarget.isInterceptable()) {
									return null;
								}

								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.OperatorNameGetter",
										"operatorName");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.FilterGetter",
										"fieldName");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.GeometryGetter",
										"geometry");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.MaxDistanceGetter",
										"maxDistance");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.MinDistanceGetter",
										"minDistance");
					...
					if (nestedClass.getName().equals(MongoConstants.MONGO_FILTER_SIMPLEENCODING)) {
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.FieldNameGetter",
										"fieldName");
								nestedTarget.addGetter("com.navercorp.pinpoint.plugin.mongo.field.getter.ValueGetter",
										"value");
								return nestedTarget.toBytecode();
							}
						});
						...
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter(
										...
										"operatorName");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.IterableValuesGetter",
										"values");
								return nestedTarget.toBytecode();
							}
						});
					...
					if (nestedClass.getName().equals(MongoConstants.MONGO_FILTER_OR)) {
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.FiltersGetter",
										"filters");
								return nestedTarget.toBytecode();
							}
						});
					...
					if (nestedClass.getName().equals(MongoConstants.MONGO_FILTER_SIMPLE)) {
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
									Class<?> classBeingRedefined, ProtectionDomain protectionDomain,
									byte[] classfileBuffer) throws InstrumentException {
								InstrumentClass nestedTarget = instrumentor.getInstrumentClass(loader, className,
										classfileBuffer);
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.FieldNameGetter",
										"fieldName");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.BsonValueGetter",
										"value");
								return nestedTarget.toBytecode();
							}
						});
					...
					if (nestedClass.getName().equals(MongoConstants.MONGO_FILTER_TEXT)) {
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.SearchGetter",
										"search");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.TextSearchOptionsGetter",
										"textSearchOptions");
								return nestedTarget.toBytecode();
							}
						});
						...
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.FiltersGetter",
										"filters");
								nestedTarget.addField(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.filters.InternalOperatorNameAccessor");

								final InstrumentMethod nestedConstructor = nestedTarget.getConstructor(
										"com.mongodb.client.model.Filters$OrNorFilter$Operator", "java.lang.Iterable");

								if (nestedConstructor != null) {
									nestedConstructor.addInterceptor(
											"com.navercorp.pinpoint.plugin.mongo.interceptor.MongoInternalOperatorNameInterceptor");
								}
	...
	private void addUpdatesTransformer() {
		...
		TransformCallback transformCallback = new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				List<InstrumentClass> nestedClasses = target
						.getNestedClasses(ClassFilters.name(MongoConstants.UPDATESLIST.toArray(new String[0])));
						...
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter("com.navercorp.pinpoint.plugin.mongo.field.getter.ValueGetter",
										"value");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.OperatorGetter", "operator");
								return nestedTarget.toBytecode();
							}
						});
					}
						...
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter(
										...
										"fieldName");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.updates.ListValuesGetter",
										"values");
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.OperatorGetter", "operator");
								return nestedTarget.toBytecode();
					...
					if (nestedClass.getName().equals(MongoConstants.MONGO_UPDATES_PUSH)) {
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.updates.PushOptionsGetter",
										"options");
								return nestedTarget.toBytecode();
							}
						});
					...
					if (nestedClass.getName().equals(MongoConstants.MONGO_UPDATES_COMPOSITE)) {
						instrumentor.transform(loader, nestedClass.getName(), new TransformCallback() {
							...
							public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
								...
								nestedTarget.addGetter(
										"com.navercorp.pinpoint.plugin.mongo.field.getter.ExtendedBsonListGetter",
										"updates");
								return nestedTarget.toBytecode();
							}
						});
	...
	private void addSortsTransformer() {
		...
		TransformCallback transformCallback = new TransformCallback() {
			...
			public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
				...
				List<InstrumentClass> nestedClasses = target
						.getNestedClasses(ClassFilters.name(MongoConstants.MONGO_SORT_COMPOSITE));
	...
	private String[] getMethodlistR3_0_x() {
		...
		final String[] methodList = new String[] { "findOneAndUpdate", "findOneAndReplace", "findOneAndDelete", "find",
				"count", "distinct", "listIndexes"
				// , "watch" ,"aggregate","mapReduce"
		};
		return methodList;
	}

	private String[] getMethodlistR2_x() {

		final String[] methodList = new String[] { "findOneAndUpdate", "findOneAndReplace", "findOneAndDelete", "find",
				"count", "distinct", "listIndexes", "aggregate", "findOne"
				// , "watch" ,"aggregate","mapReduce"
		};
		return methodList;
	}
	...
	private String[] getMethodlistCUD3_0_x() {
		final String[] methodList = new String[] { "dropIndexes", "dropIndex", "createIndexes", "createIndex",
				"updateMany", "updateOne", "replaceOne", "deleteMany", "deleteOne", "insertMany", "insertOne",
				"bulkWrite" };
		return methodList;
	}

	private String[] getMethodlistCUD2_x() {
		final String[] methodList = new String[] { "dropIndexes", "dropIndex", "createIndexes", "createIndex",
				"updateMany", "updateOne", "replaceOne", "deleteMany", "deleteOne", "insertMany", "insertOne",
				"bulkWrite", "save", "update", "updateMulti" };
		return methodList;
	}
	...
	private String[] getMethodlistR3_7_x() {
		...
		final String[] methodList = new String[] { "findOneAndUpdate", "findOneAndReplace", "findOneAndDelete", "find",
				"count", "distinct", "listIndexes", "countDocuments"
				// , "watch", "aggregate", "mapReduce"
		};
