...
public class MongoCollectionImplConstructorInterceptor implements AroundInterceptor {
    private final PLogger logger = PLoggerFactory.getLogger(this.getClass());
    private final boolean isDebug = logger.isDebugEnabled();

    public MongoCollectionImplConstructorInterceptor() {
    }
    ...
    public void after(Object target, Object[] args, Object result, Throwable throwable) {
        ...
        final WriteConcern writeConcern = ArrayArgumentUtils.getArgument(args, 4, WriteConcern.class);
