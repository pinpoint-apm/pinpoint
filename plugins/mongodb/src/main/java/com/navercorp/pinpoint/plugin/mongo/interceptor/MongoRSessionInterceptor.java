...
public class MongoRSessionInterceptor extends SpanEventSimpleAroundInterceptorForPlugin {
    ...
    public MongoRSessionInterceptor(TraceContext traceContext, MethodDescriptor descriptor, boolean collectJson) {
    ...
    protected void doInBeforeTrace(SpanEventRecorder recorder, Object target, Object[] args) {
        ...
        recorder.recordMongoCollectionInfo(((MongoDatabaseInfo) databaseInfo).getCollectionName(), ((MongoDatabaseInfo) databaseInfo).getReadPreference());
    }
