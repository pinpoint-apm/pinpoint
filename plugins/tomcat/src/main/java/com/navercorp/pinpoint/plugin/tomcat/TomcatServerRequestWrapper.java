 ...
 * @author jaehong.kim
 */
public class TomcatServerRequestWrapper implements ServerRequestWrapper {
    private final HttpServletRequest request;
    private final RemoteAddressResolver<HttpServletRequest> remoteAddressResolver;

    public TomcatServerRequestWrapper(final HttpServletRequest request, final RemoteAddressResolver<HttpServletRequest> remoteAddressResolver) {
