...
public class JettyServletRequestListener implements ServletRequestListener {
    ...
    public JettyServletRequestListener(TraceContext traceContext) {
        ...
        this.servletRequestListenerInterceptorHelper = new ServletRequestListenerInterceptorHelper(traceContext, JettyConstants.JETTY, config.getExcludeUrlFilter(), config.getExcludeProfileMethodFilter(), config.isTraceRequestParam());
    }
