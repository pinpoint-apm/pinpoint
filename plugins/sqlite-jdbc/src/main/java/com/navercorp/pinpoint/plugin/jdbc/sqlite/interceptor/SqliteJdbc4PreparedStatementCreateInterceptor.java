...
public class SqliteJdbc4PreparedStatementCreateInterceptor extends PreparedStatementCreateInterceptor {

    public SqliteJdbc4PreparedStatementCreateInterceptor(TraceContext context, MethodDescriptor descriptor) {
