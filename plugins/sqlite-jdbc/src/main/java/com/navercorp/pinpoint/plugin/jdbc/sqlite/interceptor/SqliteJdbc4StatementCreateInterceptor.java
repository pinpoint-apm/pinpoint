...
public class SqliteJdbc4StatementCreateInterceptor extends StatementCreateInterceptor {

    public SqliteJdbc4StatementCreateInterceptor(TraceContext traceContext) {
        super(traceContext);
    }
