...
public class SqliteStmtExecuteUpdateInterceptor extends StatementExecuteUpdateInterceptor {

    public SqliteStmtExecuteUpdateInterceptor(TraceContext traceContext, MethodDescriptor descriptor) {
