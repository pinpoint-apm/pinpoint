...
public class MySqlPlugin implements ProfilerPlugin, TransformTemplateAware {
    ...
    private final JdbcUrlParser jdbcUrlParser = new MySqlJdbcUrlParser();
    ...
    private void addDriverTransformer() {
        transformTemplate.transform("com.mysql.jdbc.NonRegisteringDriver", new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                target.addScopedInterceptor("com.navercorp.pinpoint.bootstrap.plugin.jdbc.interceptor.DriverConnectInterceptor", va(jdbcUrlParser, false), MySqlConstants.MYSQL_SCOPE, ExecutionPolicy.ALWAYS);
