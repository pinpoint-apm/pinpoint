...
public class TestQueryString {
	...
	public void testRemoveCarriageReturn() {
		...
		Assert.assertEquals("this is awesome CRs  and awesome LFs  what if we combine it?      wow  so standard  much naver ",
				QueryStringUtil.removeCarriageReturn(testStr));
	}
	
	@Test
	public void testRemoveAllMultiSpace() {
		String testStr;
		//single spaces
		testStr = " ";
		...
		Assert.assertEquals(" bad example of design by making hu ge s p a c e ",
				QueryStringUtil.removeAllMultiSpace(QueryStringUtil.removeCarriageReturn(testStr)));
	}
