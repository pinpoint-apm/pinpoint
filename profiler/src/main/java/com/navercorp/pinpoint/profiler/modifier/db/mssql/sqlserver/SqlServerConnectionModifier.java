 ...
 * @author Barney Kim
 */
public class SqlServerConnectionModifier extends MsSqlConnectionModifier {

    /**
     * @param byteCodeInstrumentor
     * @param agent
     */
    public SqlServerConnectionModifier(ByteCodeInstrumentor byteCodeInstrumentor, Agent agent) {
    ...
    public String getTargetClass() {
        return "com/microsoft/sqlserver/jdbc/SQLServerConnection";
    }
