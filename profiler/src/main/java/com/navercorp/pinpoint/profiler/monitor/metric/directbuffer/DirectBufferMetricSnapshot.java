 ...
 * @author Roy Kim
 */
public class DirectBufferMetricSnapshot {
    ...
    public DirectBufferMetricSnapshot(long directCount, long directMemoryUsed, long mappedCount, long mappedMemoryUsed){
