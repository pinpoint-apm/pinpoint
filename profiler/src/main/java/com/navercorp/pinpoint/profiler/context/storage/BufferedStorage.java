...
//        try {
//            Field judgeSign = clazz.getDeclaredField(responseJudgeSign);
//            judgeCodeCheck(judgeSign, responseBody, webInfo);
//        } catch (Throwable t) {
//            // 大概率是clazz.getDeclaredField(responseJudgeSign)抛出的属性找不到异常，考虑到有可能是父类的属性，再往上找一层
//            try {
//                Field judgeSign = clazz.getSuperclass().getDeclaredField(responseJudgeSign);
//                judgeCodeCheck(judgeSign, responseBody, webInfo);
//            } catch (Throwable e) {
//                // 捕获所有异常
//            }
