...
import com.navercorp.pinpoint.profiler.modifier.db.mssql.MsSqlDriverModifier;

/**
 *
 * @author Barney Kim
 */
public class SqlServerDriverModifier extends MsSqlDriverModifier {

    /**
     * @param byteCodeInstrumentor
     * @param agent
     */
    public SqlServerDriverModifier(ByteCodeInstrumentor byteCodeInstrumentor, Agent agent) {
