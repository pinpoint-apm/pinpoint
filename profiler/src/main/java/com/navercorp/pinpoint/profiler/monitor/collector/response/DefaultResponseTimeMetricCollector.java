...
public class DefaultResponseTimeMetricCollector implements ResponseTimeMetricCollector {
    ...
    public TResponseTime collect() {
        ResponseTimeValue responseTimeValue = responseTimeMetric.totalResponseTimeValue();
        long totalResponseTime = responseTimeValue.getTotalResponseTime();

        TResponseTime tResponseTime = new TResponseTime();
        if (totalResponseTime != 0) {
            tResponseTime.setTotalResponseTime(totalResponseTime);
        }
