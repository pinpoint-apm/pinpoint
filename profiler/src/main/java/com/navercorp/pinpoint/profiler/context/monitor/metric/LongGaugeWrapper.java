 ...
 * @author Taejin Koo
 */
public class LongGaugeWrapper extends AbstractCustomMetricWrapper<LongGauge> implements LongGauge {

    public LongGaugeWrapper(int id, LongGauge customMetric) {
    ...
    public CustomMetricVo snapshot() {
        return new LongGaugeMetricVo(this);
    }
}
