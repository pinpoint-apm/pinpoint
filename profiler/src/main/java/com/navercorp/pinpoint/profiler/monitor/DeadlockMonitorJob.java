 ...
 * @author Taejin Koo
 */
public class DeadlockMonitorJob implements Runnable {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private final DeadlockThreadRegistry deadlockThreadRegistry;

    public DeadlockMonitorJob(DeadlockThreadRegistry deadlockThreadRegistry) {
    ...
    public void run() {
        ...
        if (foundNewDeadlockedThread) {
            ...
            deadlockOutput.append("\r\n");
            deadlockOutput.append("================================================================").append("\r\n");
            deadlockOutput.append("[PINPOINT] Found one Java-level deadlock:").append("\r\n");
            deadlockOutput.append("\r\n");
            deadlockOutput.append("If pinpoints affect the deadlock below, please put all the information posted on pinpoint's github.").append("\r\n");
            deadlockOutput.append("(https://github.com/naver/pinpoint/issues)").append("\r\n");
            deadlockOutput.append("================================================================").append("\r\n");
