...
public interface ContainerMetric {
    ...
    ContainerMetric UNSUPPORTED_CONTAINER_METRIC = new ContainerMetric() {
        ...
        private final ContainerMetricSnapshot uncollectedSanpshot = new ContainerMetricSnapshot(UNCOLLECTED_VALUE, UNCOLLECTED_VALUE, UNCOLLECTED_VALUE);

        @Override
        public ContainerMetricSnapshot getSnapshot() {
            return uncollectedSanpshot;
        }
