...
public class AutoBindingObjectFactory<T> {
    ...
    public AutoBindingObjectFactory(TraceContext traceContext, PluginContext pluginContext, ByteCodeInstrumentor instrumentor, InstrumentClass targetClass, Object[] providedValues) {
        this(traceContext, pluginContext, instrumentor, targetClass, null, providedValues);
    }

    public AutoBindingObjectFactory(TraceContext traceContext, PluginContext pluginContext, ByteCodeInstrumentor instrumentor, InstrumentClass targetClass, MethodInfo targetMethod, Object[] providedValues) {
