 ...
 * @author Taejin Koo
 */
public class IntGaugeWrapper extends AbstractCustomMetricWrapper<IntGauge> implements IntGauge {

    public IntGaugeWrapper(int id, IntGauge customMetric) {
    ...
    public CustomMetricVo snapshot() {
        return new IntGaugeMetricVo(this);
    }
