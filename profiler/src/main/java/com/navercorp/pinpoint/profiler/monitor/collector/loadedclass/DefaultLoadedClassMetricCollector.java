...
public class DefaultLoadedClassMetricCollector implements AgentStatMetricCollector<LoadedClassMetricSnapshot> {
    ...
    public LoadedClassMetricSnapshot collect() {
        final LoadedClassMetricSnapshot snapshot = loadedClassMetric.getSnapshot();
        return snapshot;
    }

    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("DefaultLoadedClassMetricCollector{");
        sb.append("loadedClassMetric=").append(loadedClassMetric);
        sb.append('}');
        return sb.toString();
    }
}
