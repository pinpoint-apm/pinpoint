...
public class DataSourceMetricSet implements MetricSet {
    ...
    public DataSourceMetricSet(PluginMonitorWrapperLocator<DataSourceMonitorWrapper> dataSourceMonitorLocator, JdbcUrlParserManager jdbcUrlParserManager) {
    ...
    public Map<String, Metric> getMetrics() {
        ...
        for (DataSourceMonitorWrapper dataSourceMonitor : dataSourceMonitorList) {
            gauges.put(MetricMonitorValues.DATASOURCE + "." + dataSourceMonitor.getId(), new DataSourceGauge(dataSourceMonitor, jdbcUrlParserManager));
        }
