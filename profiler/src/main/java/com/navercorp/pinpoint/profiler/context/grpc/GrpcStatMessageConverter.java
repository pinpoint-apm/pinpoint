...
import com.navercorp.pinpoint.profiler.monitor.metric.profilermetric.ProfilerMetric;
...
public class GrpcStatMessageConverter implements MessageConverter<MetricType, GeneratedMessageV3> {
    ...
    private final MessageConverter<MetricType, PProfilerMetric> profilerMetricConverter = new GrpcProfilerMetricMessageConverter();
    ...
    public GeneratedMessageV3 toMessage(MetricType message) {
        if (message instanceof AgentStatMetricSnapshotBatch) {
            ...
            return agentUriStat;
        } else if (message instanceof ProfilerMetric) {
            final ProfilerMetric profilerMetricData = (ProfilerMetric) message;
            final PProfilerMetric profilerMetricMessage = profilerMetricConverter.toMessage(profilerMetricData);
            return profilerMetricMessage;
        }
        return null;
    }
