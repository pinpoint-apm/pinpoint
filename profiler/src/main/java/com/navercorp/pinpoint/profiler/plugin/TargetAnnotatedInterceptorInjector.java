...
public class TargetAnnotatedInterceptorInjector implements ClassRecipe {
    ...
    public TargetAnnotatedInterceptorInjector(TraceContext traceContext, ProfilerPluginContext pluginContext, ByteCodeInstrumentor instrumentor, String interceptorName, Object[] providedArguments) {
    ...
    private MethodEditor createFilteredMethodEditor(TargetFilter annotation, InstrumentClass targetClass, InterceptorInjector injector) {
        ...
        return new FilteringMethodEditor(filter, injector);
    }
}
