...
public class DefaultTotalThreadMetricCollector implements AgentStatMetricCollector<TotalThreadMetricSnapshot> {
    ...
    public TotalThreadMetricSnapshot collect() {
        final TotalThreadMetricSnapshot snapshot = totalThreadMetric.getSnapshot();
        return snapshot;
    }

    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("DefaultTotalThreadMetricCollector{");
        sb.append("totalThreadMetric=").append(totalThreadMetric);
        sb.append('}');
        return sb.toString();
    }
}
