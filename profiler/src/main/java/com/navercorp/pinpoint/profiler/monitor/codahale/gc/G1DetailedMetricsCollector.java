...
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_GC_G1_NEWGEN_COUNT;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_GC_G1_NEWGEN_TIME;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_G1_CODE_CACHE_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_G1_METASPACE_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_G1_NEWGEN_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_G1_OLDGEN_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_G1_PERMGEN_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_G1_SURVIVOR_USAGE;
...
/**
 * HotSpot's Garbage-First(G1) collector with detailed metrics
 *
 * @author dawidmalina
 */
