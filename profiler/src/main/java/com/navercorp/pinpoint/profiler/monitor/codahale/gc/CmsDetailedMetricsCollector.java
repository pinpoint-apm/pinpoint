...
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_GC_CMS_NEWGEN_COUNT;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_GC_CMS_NEWGEN_TIME;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_CMS_CODE_CACHE_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_CMS_METASPACE_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_CMS_NEWGEN_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_CMS_OLDGEN_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_CMS_PERMGEN_USAGE;
import static com.navercorp.pinpoint.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_CMS_SURVIVOR_USAGE;
...
/**
 * HotSpot's Concurrent-Mark-Sweep collector with detailed metrics
 *
 * @author dawidmalina
 */
public class CmsDetailedMetricsCollector extends CmsCollector {
    ...
    public TJvmGc collect() {
        ...
        if (EXCLUDED_DOUBLE.equals(permGenUsage.getValue())) {
            // exclude metric for jvm >= 1.8
