...
public class AgentHeaderFactoryProvider implements Provider<HeaderFactory> {
    ...
    public HeaderFactory get() {
        return new AgentHeaderFactory(agentInformation.getAgentId(), agentInformation.getApplicationName(), agentInformation.getStartTime(), agentInformation.getServerType().getCode());
    }
}
