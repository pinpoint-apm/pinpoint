...
public class DefaultResponseTimeMetricCollectorTest {
    ...
    @Mock
    private ResponseTimeHistogramValue responseTimeHistogramValue;
    ...
    public void setUp() {
        ...
        when(responseTimeHistogramValue.getCount()).thenReturn(COUNT);
        when(responseTimeHistogramValue.getAvg()).thenReturn(totalValue / COUNT);

        when(responseTimeMetric.responseTimeHistogram()).thenReturn(responseTimeHistogramValue);
    }
    ...
    public void defaultTest() throws Exception {
        ...
        Assert.assertEquals(COUNT, collect.getCount());
