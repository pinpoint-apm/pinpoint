...
public class MockApplicationContextFactory {
    ...
    public DefaultApplicationContext build(ProfilerConfig config, ModuleFactory moduleFactory) {
        ...
        AgentOption agentOption = new DefaultAgentOption(instrumentation, "mockLicence", mockAgent, mockApplicationName, false, config, Collections.<String>emptyList(), null);
