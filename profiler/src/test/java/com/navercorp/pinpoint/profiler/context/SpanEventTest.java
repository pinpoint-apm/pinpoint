...
public class SpanEventTest {
    ...
    public void testMarkStartTime() {
        ...
        span.setElapsed((int) (span.getStartTime() + 10));
        ...
        compressorV1.postProcess(spanEvent, tSpanEvent, context);

        Assert.assertEquals("startTime", span.getStartTime() + tSpanEvent.getStartElapsed(), spanEvent.getStartTime());
        Assert.assertEquals("endTime", span.getStartTime() + tSpanEvent.getStartElapsed() + spanEvent.getEndElapsed(), spanEvent.getAfterTime());
    }
