 ...
 * @author minwoo.jung
 */
public class ResponseTimeDao extends DefaultApplicationMetricDao<JoinResponseTimeBo> {


    public ResponseTimeDao(ApplicationStatSerializer<JoinResponseTimeBo> serializer,
                           HbaseTemplate2 hbaseTemplate2,
                           ApplicationStatHbaseOperationFactory operations,
                           TableNameProvider tableNameProvider) {
        super(StatType.APP_RESPONSE_TIME, JoinApplicationStatBo::getJoinResponseTimeBoList, serializer, HbaseTable.APPLICATION_STAT_AGGRE,
