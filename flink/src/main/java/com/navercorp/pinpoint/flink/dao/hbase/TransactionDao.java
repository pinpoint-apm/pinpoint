 ...
 * @author minwoo.jung
 */
public class TransactionDao extends DefaultApplicationMetricDao<JoinTransactionBo> {

    public TransactionDao(ApplicationStatSerializer<JoinTransactionBo> serializer,
                          HbaseTemplate2 hbaseTemplate2,
                          ApplicationStatHbaseOperationFactory operationFactory,
                          TableNameProvider tableNameProvider) {
        super(StatType.APP_TRANSACTION_COUNT, JoinApplicationStatBo::getJoinTransactionBoList, serializer, HbaseTable.APPLICATION_STAT_AGGRE,
