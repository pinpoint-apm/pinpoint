 ...
 */
public class LegacyFluxClientAdaptor<D, S> implements FluxChannelServiceClient<D, S> {

    private final FluxChannelServiceClient<DemandMessage<D>, SupplyMessage<S>> delegate;
    private final Function<D, Long> idFn;

    public LegacyFluxClientAdaptor(
            FluxChannelServiceClient<DemandMessage<D>, SupplyMessage<S>> delegate,
