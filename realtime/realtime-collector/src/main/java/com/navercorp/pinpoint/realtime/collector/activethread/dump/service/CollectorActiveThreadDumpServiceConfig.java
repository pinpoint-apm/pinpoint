...
public class CollectorActiveThreadDumpServiceConfig {

    @Bean
    ActiveThreadDumpService activeThreadDumpService(AgentCommandService commandService) {
        return new ActiveThreadDumpServiceImpl(commandService);
    }
