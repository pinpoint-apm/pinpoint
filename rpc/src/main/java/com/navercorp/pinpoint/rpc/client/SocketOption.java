...
public class SocketOption implements Cloneable {
    ...
    public static class Builder {
        ...
        private int writeBufferHighWaterMark = ByteSizeUnit.MEGA_BYTES.toBytesSizeAsInt(16);
        private int writeBufferLowWaterMark = ByteSizeUnit.MEGA_BYTES.toBytesSizeAsInt(8);
