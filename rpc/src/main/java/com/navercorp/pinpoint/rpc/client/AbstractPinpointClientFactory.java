 ...
 */
public abstract class AbstractPinpointClientFactory implements PinpointClientFactory {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    protected final AtomicInteger socketId = new AtomicInteger(1);

    protected final Closed closed = new Closed();

    protected final ChannelFactory channelFactory;
    protected final SocketOption.Builder socketOptionBuilder;

    protected Map<String, Object> properties = Collections.emptyMap();

    protected final Timer timer;

    protected final ClientOption.Builder clientOptionBuilder = new ClientOption.Builder();

    protected ClusterOption clusterOption = ClusterOption.DISABLE_CLUSTER_OPTION;
    ...
    public AbstractPinpointClientFactory() {
        this(1, 1);
    }

    public AbstractPinpointClientFactory(int bossCount, int workerCount) {
        if (bossCount < 1) {
