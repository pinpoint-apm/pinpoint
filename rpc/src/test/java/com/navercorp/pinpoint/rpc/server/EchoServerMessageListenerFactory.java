 ...
 * @author Taejin Koo
 */
public class EchoServerMessageListenerFactory implements ServerMessageListenerFactory {

    private final boolean enableDuplex;

    public EchoServerMessageListenerFactory() {
        this(false);
    }

    public EchoServerMessageListenerFactory(boolean enableDuplex) {
        this.enableDuplex = enableDuplex;
    }

    @Override
    public ServerMessageListener create() {
        return new EchoServerMessageListener(enableDuplex);
    }


    private static class EchoServerMessageListener implements ServerMessageListener {

        private final Logger logger = LoggerFactory.getLogger(this.getClass());

        private final boolean enableDuplex;

        public EchoServerMessageListener(boolean enableDuplex) {
            this.enableDuplex = enableDuplex;
        }
