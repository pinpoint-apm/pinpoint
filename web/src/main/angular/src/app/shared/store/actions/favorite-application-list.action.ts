...
export const getFavApplicationListFail = createAction('[Favorite Application List] Get Favorite Application List Fail', (error: IServerErrorFormat) => ({errorType: ErrorType.GET, error}));
...
export const addFavApplicationFail = createAction('[Favorite Application List] Add Favorite Application Fail', (error: IServerErrorFormat) => ({errorType: ErrorType.ADD, error}));
...
export const removeFavApplicationFail = createAction('[Favorite Application List] Remove Favorite Application Fail', (error: IServerErrorFormat) => ({errorType: ErrorType.REMOVE, error}));
