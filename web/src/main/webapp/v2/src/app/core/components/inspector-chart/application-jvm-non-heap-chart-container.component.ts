...
@Component({
    selector: 'pp-application-jvm-non-heap-chart-container',
    templateUrl: './application-jvm-non-heap-chart-container.component.html',
    styleUrls: ['./application-jvm-non-heap-chart-container.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ApplicationJVMNonHeapChartContainerComponent extends InspectorChartContainer implements OnInit, OnDestroy {
    constructor(
    ...
    onShowHelp($event: MouseEvent): void {
        super.onShowHelp($event, HELP_VIEWER_LIST.APPLICATION_NON_HEAP);
    }
}
