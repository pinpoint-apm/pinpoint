...
@Component({
    selector: 'pp-agent-jvm-heap-chart-container',
    templateUrl: './agent-jvm-heap-chart-container.component.html',
    styleUrls: ['./agent-jvm-heap-chart-container.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class AgentJVMHeapChartContainerComponent extends InspectorChartContainer implements OnInit, OnDestroy {
    constructor(
    ...
    onShowHelp($event: MouseEvent): void {
        super.onShowHelp($event, HELP_VIEWER_LIST.AGENT_HEAP);
    }
}
