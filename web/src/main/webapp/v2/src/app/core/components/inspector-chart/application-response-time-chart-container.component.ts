...
@Component({
    selector: 'pp-application-response-time-chart-container',
    templateUrl: './application-response-time-chart-container.component.html',
    styleUrls: ['./application-response-time-chart-container.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ApplicationResponseTimeChartContainerComponent extends InspectorChartContainer implements OnInit, OnDestroy {
    constructor(
        ...
        chartDataService: ApplicationResponseTimeChartDataService,
    ...
    onShowHelp($event: MouseEvent): void {
        super.onShowHelp($event, HELP_VIEWER_LIST.APPLICATION_RESPONSE_TIME);
    }
}
