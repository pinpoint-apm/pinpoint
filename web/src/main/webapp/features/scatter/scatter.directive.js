(function() {
	...
	pinpointApp.directive('scatterDirective', ['scatterDirectiveConfig', '$rootScope', '$timeout', 'webStorage', 'TransactionDaoService', '$window', 'helpContentService',
        function (cfg, $rootScope, $timeout, webStorage, oTransactionDaoService, $window, helpContentService) {
            return {
...
//                            oTransactionDaoService.addData(token, transactions);
                        ...
                        oScatterChart = new BigScatterChart(options, helpContentService);
                        $timeout(function () {
