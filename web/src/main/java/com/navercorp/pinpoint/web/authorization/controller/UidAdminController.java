...
import com.navercorp.pinpoint.uid.service.ApplicationUidCleanupService;
...
public class UidAdminController {
    ...
    private final ApplicationUidCleanupService applicationUidCleanupService;
    ...
    public UidAdminController(ApplicationUidService applicationUidService,
                              ApplicationUidCleanupService applicationUidCleanupService,
        ...
        this.applicationUidCleanupService = Objects.requireNonNull(applicationUidCleanupService, "applicationUidCleanupService");
