...
public class FileDescriptorChartService implements AgentStatChartService {
    ...
    private final SampledAgentStatDao<SampledFileDescriptor> sampledFileDescriptorDao;

    public FileDescriptorChartService(@Qualifier("sampledFileDescriptorDaoFactory") SampledAgentStatDao<SampledFileDescriptor> sampledFileDescriptorDao) {
