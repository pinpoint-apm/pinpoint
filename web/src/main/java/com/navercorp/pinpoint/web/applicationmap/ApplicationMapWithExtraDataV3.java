...
public class ApplicationMapWithExtraDataV3 implements ApplicationMap {
    ...
    public ApplicationMapWithExtraDataV3(ApplicationMap applicationMap, Map<Application, ScatterData> applicationScatterDataMap, ApplicationMapTimeData applicationMapTimeData, Map<Application, Histogram> applicationMapHistogram) {
        ...
        this.applicationMapTimeData = Objects.requireNonNull(applicationMapTimeData, "applicationMapTimeData");
        this.applicationHistogramDataMap = Objects.requireNonNull(applicationMapHistogram, "applicationMapHistogram");
    }
