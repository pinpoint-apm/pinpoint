...
public class ApplicationServiceImpl implements ApplicationService {
    ...
    public List<Application> getApplications(ServiceId serviceId) {
        ...
        if (serviceId.equals(ServiceId.DEFAULT_ID)) {
            applications.addAll(this.applicationIndexDao.selectAllApplicationNames());
        }
    ...
    private List<Application> augmentApplicationName(List<Application> applications) {
        ...
        for (Application application : applications) {
            ...
            if (helper != null) {
                result.add(new Application(helper.serviceId(), helper.id(), helper.name(), helper.serviceType()));
            }
        }
        return result;
    }
    ...
    private List<Application> augmentApplicationId(List<Application> applications) {
        List<Application> result = new ArrayList<>(applications.size());
        for (Application application : applications) {
            ApplicationId applicationId = this.applicationInfoService.getApplicationId(new ApplicationSelector(ServiceId.DEFAULT_ID, application.name()));
            if (applicationId != null) {
                result.add(new Application(ServiceId.DEFAULT_ID, applicationId, application.name(), application.serviceType()));
            }
        }
        return result;
    }
