...
public class LoadedClassCountChartService implements AgentStatChartService{
    private final SampledAgentStatDao<SampledLoadedClassCount> sampledLoadedClassCountDao;

    public LoadedClassCountChartService(@Qualifier("sampledLoadedClassCountDaoFactory") SampledAgentStatDao<SampledLoadedClassCount> sampledLoadedClassCountDao) {
