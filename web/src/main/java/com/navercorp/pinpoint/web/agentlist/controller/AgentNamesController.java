...
public class AgentNamesController {
    ...
    public List<AgentNameGroupView> getAgentsListGroupedByNameWithVirtualNodes(
        ...
        final List<Application> fromApplications = pairsToList(applicationPairs.getFromApplications());
        final List<Application> toApplications = pairsToList(applicationPairs.getToApplications());
        ...
        List<AgentStatusAndLink> agents = AgentsFactory.extractVirtualNode(nodeHistogramSummary, hyperLinkFactory);
        return AgentsFactory.groupByAgentName(agents);
    }
