...
public class HeatMapServiceImpl implements HeatMapService {
    ...
    private final ApplicationTraceIndexV2Dao applicationTraceIndexV2Dao;

    private final TraceDao traceDao;
    private final SpanService spanService;

    public HeatMapServiceImpl(ApplicationTraceIndexDao applicationTraceIndexDao,
                              ApplicationTraceIndexV2Dao applicationTraceIndexV2Dao,
                              SpanService spanService,
                              TraceDao traceDao) {
        this.applicationTraceIndexDao = Objects.requireNonNull(applicationTraceIndexDao, "applicationTraceIndexDao");
        this.applicationTraceIndexV2Dao = Objects.requireNonNull(applicationTraceIndexV2Dao, "applicationTraceIndexV2Dao");
    ...
    public LimitedScanResult<List<DotMetaData>> dragScatterDataV3(int serviceUid, String applicationName, int serviceTypeCode, DragAreaQuery dragAreaQuery, int limit) {
        ...
        LimitedScanResult<List<DotMetaData>> scanResult = applicationTraceIndexV2Dao.scanScatterDataV2(serviceUid, applicationName, serviceTypeCode, dragAreaQuery, limit);
        List<DotMetaData> scanData = scanResult.scanData();
        logger.debug("dragScatterArea applicationName:{} dots:{}", applicationName, scanResult);
    ...
    public LimitedScanResult<HeatMap> getHeatMapV2(int serviceUid, String applicationName, int serviceTypeCode, Range range, long maxY, int limit) {
        ...
        LimitedScanResult<List<Dot>> scanResult = applicationTraceIndexV2Dao.scanTraceScatterData(serviceUid, applicationName, serviceTypeCode, range, limit, true);
