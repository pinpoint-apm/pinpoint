...
import com.navercorp.pinpoint.common.util.concurrent.OrderedThreadPoolRunnable;
 ...
 * @Author Taejin Koo
 */
public class OrderedWebSocketFlushRunnable implements OrderedThreadPoolRunnable<String> {
