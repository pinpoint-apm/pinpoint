 ...
 */
@Repository
public class HbaseApplicationTraceIndexDaoV2 implements ApplicationTraceIndexDaoV2 {
    ...
    public HbaseApplicationTraceIndexDaoV2(ScatterChartProperties scatterChartProperties,
    ...
    public boolean hasTraceIndex(UUID applicationId, Range range, boolean backwardDirection) {
        ...
        Scan scan = createScan(applicationId, range, backwardDirection, 1);
    ...
    public LimitedScanResult<List<TransactionId>> scanTraceIndex(final UUID applicationId, Range range, int limit, boolean scanBackward) {
        ...
        Scan scan = createScan(applicationId, range, scanBackward, -1);
...
//        Predicate<Dot> filter = ElpasedTimeDotPredicate.newDragAreaDotPredicate(dragArea);
    ...
    public LimitedScanResult<List<Dot>> scanScatterData(UUID applicationId, DragAreaQuery dragAreaQuery, int limit) {
        ...
        return scanScatterData0(applicationId, dragAreaQuery, limit, false, mapper);
    }
    ...
    private <R> LimitedScanResult<List<R>> scanScatterData0(UUID applicationId, DragAreaQuery dragAreaQuery, int limit,
        ...
        Scan scan = newFuzzyScanner(applicationId, dragArea, range);
        if (metadataScan) {
