...
public class WebApplicationUidConfig {
    ...
    @Bean
    @ConfigurationProperties(prefix = "web.application.name.cache")
    public CaffeineCacheProperties applicationNameCacheProperties() {
        return new CaffeineCacheProperties();
    }
    ...
    @Bean
    public CacheManager applicationNameCache(@Qualifier("applicationNameCacheProperties") CaffeineCacheProperties caffeineCacheProperties) {
