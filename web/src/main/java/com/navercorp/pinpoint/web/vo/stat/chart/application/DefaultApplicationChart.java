...
public class DefaultApplicationChart<T, P extends Point> implements StatChart<P> {
    private final TimeWindow timeWindow;
    private final List<T> statList;
    private final ChartGroupBuilder<T, P> builder;

    public DefaultApplicationChart(TimeWindow timeWindow, List<T> statList, ChartGroupBuilder<T, P> builder) {
