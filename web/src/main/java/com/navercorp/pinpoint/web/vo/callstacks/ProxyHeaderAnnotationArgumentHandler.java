...
public class ProxyHeaderAnnotationArgumentHandler implements AnnotationHandler {
    ...
    public ProxyHeaderAnnotationArgumentHandler(ProxyRequestTypeRegistryService proxyRequestTypeRegistryService) {
