...
public class DeadlockChartService implements AgentStatChartService {
    ...
    private final SampledAgentStatDao<SampledDeadlock> sampledDeadlockDao;

    public DeadlockChartService(@Qualifier("sampledDeadlockDaoFactory") SampledAgentStatDao<SampledDeadlock> sampledDeadlockDao) {
