...
public class RecordFactory {
    ...
    public Record get(final CallTreeNode node) {
        ...
        final Record record = new DefaultRecord(align.getDepth(),
                ...
                api.getMethod(),
                argument,
                align.getStartTimeMillis(),
                align.getStartTimeNanos(),
                align.getEndTimeNanos(),
                align.getElapsedMillis(),
                align.getElapsedNanos(),
                align.getGapMillis(),
                align.getGapNanos(),
                align.getAgentId(),
                align.getAgentName(),
                ...
                align.getSpanId(),
                align.getExecutionMillis(),
                align.getExecutionNanos(),
