...
public class ApplicationFileDescriptorService implements ApplicationStatChartService {
    ...
    private final ApplicationMetricDao<AggreJoinFileDescriptorBo> metricDao;
    ...
    public StatChart selectApplicationChart(String applicationId, TimeWindow timeWindow) {
        ...
        List<AggreJoinFileDescriptorBo> aggreJoinFileDescriptorBoList = this.metricDao.getApplicationStatList(applicationId, timeWindow);
