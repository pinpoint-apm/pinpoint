 ...
 * @author intr3p1d
 */
public class ApplicationMapNodeHistogramFactory implements NodeHistogramFactory {

    private final Logger logger = LogManager.getLogger(this.getClass());

    private final WasNodeHistogramDataSource wasNodeHistogramDataSource;

    public ApplicationMapNodeHistogramFactory(WasNodeHistogramDataSource wasNodeHistogramDataSource) {
