...
public class WebServiceUidConfig {

    private final Logger logger = LogManager.getLogger(WebServiceUidConfig.class);

    public WebServiceUidConfig() {
        logger.info("Install {}", WebServiceUidConfig.class.getSimpleName());
    }
