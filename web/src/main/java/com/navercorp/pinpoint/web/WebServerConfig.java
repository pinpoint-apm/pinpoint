...
public class WebServerConfig {
    ...
    public Filter rewriteFilter(@Value("${pinpoint.web.version-prefix.main-path:/index.html}") String mainPath,
                                @Value("${pinpoint.web.version-prefix.special-paths:/api,/api-public}") String[] specialPaths,
                                @Value("${pinpoint.web.version-prefix.resource-paths:/assets,/fronts,/img}") String[] resourcePaths) {
