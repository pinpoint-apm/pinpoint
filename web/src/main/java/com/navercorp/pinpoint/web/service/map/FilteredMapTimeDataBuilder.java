...
public class FilteredMapTimeDataBuilder {
    ...
    public FilteredMapTimeDataBuilder(ApplicationFactory applicationFactory, ServiceTypeRegistryService registry, Range range, int version) {
    ...
    public FilteredMapTimeDataBuilder serverMapDataFilter(ServerMapDataFilter serverMapDataFilter) {
        this.serverMapDataFilter = serverMapDataFilter;
        return this;
    }

    public FilteredMapTimeDataBuilder addTransactions(List<List<SpanBo>> transactionList) {
    ...
    public FilteredMapTimeDataBuilder addTransaction(List<SpanBo> transaction) {
    ...
    public FilteredMapTimeData build() {
        ResponseHistograms responseHistograms = responseHistogramsBuilder.build();
        return new FilteredMapTimeData(linkDataDuplexMap, responseHistograms);
    }
