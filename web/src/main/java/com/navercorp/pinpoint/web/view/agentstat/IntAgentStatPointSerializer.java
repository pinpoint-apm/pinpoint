 ...
 */
public class IntAgentStatPointSerializer extends JsonSerializer<IntAgentStatPoint> {

    @Override
    public void serialize(IntAgentStatPoint agentStatPoint, JsonGenerator jgen, SerializerProvider serializers) throws IOException {
