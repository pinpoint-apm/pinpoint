...
public class AdminController {
    ...
    public String removeApplicationName(
        ...
        try {
            ApplicationId applicationId = this.getApplicationId(serviceName, applicationName);
    ...
    private ApplicationId getApplicationId(String serviceName, String applicationName) {
        ...
        ApplicationId applicationId = this.applicationInfoService.getApplicationId(new ApplicationSelector(serviceId, applicationName));
