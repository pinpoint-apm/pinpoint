...
public class HbaseMapStatisticsCallerDao implements MapStatisticsCallerDao {
    ...
    public LinkDataMap selectCaller(Application callerApplication, Range range) {
        ...
        LinkDataMap linkDataMap = hbaseTemplate.findParallel(mapStatisticsCalleeTableName, scan, rowKeyDistributorByHashPrefix, resultExtractor, MAP_STATISTICS_CALLEE_VER2_NUM_PARTITIONS);
