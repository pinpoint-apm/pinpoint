...
public class BidirectionalLinkSelectorTest extends LinkSelectorTestBase {
    ...
    public void testBidirectionalGraph() {
        ...
        Assertions.assertNotNull(linkData_IN_to_IN_OUT);
        Assertions.assertEquals(callCount, linkData_IN_to_IN_OUT.getTotalCount());
        ...
        Assertions.assertNotNull(linkData_OUT_IN_to_OUT);
        Assertions.assertEquals(callCount, linkData_OUT_IN_to_OUT.getTotalCount());
    }
}
