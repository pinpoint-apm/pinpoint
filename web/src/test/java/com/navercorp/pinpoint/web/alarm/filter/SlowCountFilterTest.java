...
public class SlowCountFilterTest {
    ...
    private static final String SERVICE_NAME = "minwoo_local"; 
    ...
    public void checkTest1() {
        ...
        DataCollector collector = new ResponseTimeDataCollector(application, mockMapResponseDAO, System.currentTimeMillis(), 300000);
