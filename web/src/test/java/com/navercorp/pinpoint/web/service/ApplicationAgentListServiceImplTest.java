...
public class ApplicationAgentListServiceImplTest {
    ...
    public void allAgentListTest() {
        ...
        List<AgentAndStatus> agentAndStatusList = applicationAgentListService.allAgentList(testApplicationName, range, AgentInfoFilters.acceptAll());
    ...
    public void activeStatusAgentListTest() {
        ...
        List<AgentAndStatus> agentAndStatusList = applicationAgentListService.activeStatusAgentList(testApplicationName, range, AgentInfoFilters.acceptAll());
    ...
    public void activeResponseAgentListTest() {
        ...
        List<AgentAndStatus> agentAndStatusList = applicationAgentListService.activeResponseAgentList(testApplicationName, range, AgentInfoFilters.acceptAll());
