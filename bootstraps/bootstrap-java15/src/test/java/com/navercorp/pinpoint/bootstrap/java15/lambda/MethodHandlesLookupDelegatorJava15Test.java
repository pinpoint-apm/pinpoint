...
public class MethodHandlesLookupDelegatorJava15Test {
    ...
    public void defineHiddenClass() throws Exception {
        ...
        MethodHandles.Lookup.ClassOption[] classOptionArray = new MethodHandles.Lookup.ClassOption[]{};
        try {
            MethodHandlesLookupDelegatorJava15.defineHiddenClass(lookup, bytes, initialize, classOptionArray);
        } catch (Throwable ignored) {
        }

        verify(handlerMock).handleLambdaBytecode(any(), any(), any());
    }
}