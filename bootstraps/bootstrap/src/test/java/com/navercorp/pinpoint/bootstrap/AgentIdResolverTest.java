...
public class AgentIdResolverTest {
    ...
    public void resolve() {
        ...
        AgentProperties ap = new AgentProperties(
                AgentIdSourceType.AGENT_ARGUMENT,
                properties,
    ...
    private static AgentIds getIds(AgentProperties ap) {
        Properties properties2 = new Properties();
        properties2.setProperty(AgentIdResolver.APPLICATION_NAME, "appName2");
        AgentProperties ap2 = new AgentProperties(
                AgentIdSourceType.SYSTEM,
                properties2,
                AgentIdResolver.AGENT_ID,
                AgentIdResolver.AGENT_NAME,
                AgentIdResolver.APPLICATION_NAME,
    ...
    public void resolve_multi_source_2() {
        ...
        AgentIds resolve = getAgentIds(ap);
    ...
    private static AgentIds getAgentIds(AgentProperties ap) {
        Properties properties2 = new Properties();
