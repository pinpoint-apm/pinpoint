...
public class Header {
    ...
    public Header(String agentId, String applicationName, long agentStartTime, long socketId, int serviceType, List<Integer> supportCommandCodeList) {
        this(agentId, applicationName, agentStartTime, socketId, serviceType, supportCommandCodeList, Collections.<String, Object>emptyMap());
    }

    public Header(String agentId, String applicationName, long agentStartTime, long socketId, int serviceType, List<Integer> supportCommandCodeList, final Map<String, Object> properties) {
