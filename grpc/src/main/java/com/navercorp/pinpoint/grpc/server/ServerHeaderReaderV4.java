 ...
 * @author jaehong.kim
 */
public class ServerHeaderReaderV4 implements HeaderReader<Header> {
    ...
    public ServerHeaderReaderV4(String name, Function<Metadata, Map<String, Object>> metadataConverter) {
    ...
    public Header extract(Metadata headers) {
        ...
        final String agentName = headerExtractor.getName(headers, Header.AGENT_NAME_KEY);
        ...
        return new HeaderV4(name, agentId, agentName, applicationName, serviceName, apikey,
                serviceType, startTime, socketId, supportCommandCodeList, grpcBuiltInRetry, properties);
    }

    @Override
    public String toString() {
        return "AgentHeaderReaderV4{" +
                "name='" + name + '\'' +
                '}';
    }
}
