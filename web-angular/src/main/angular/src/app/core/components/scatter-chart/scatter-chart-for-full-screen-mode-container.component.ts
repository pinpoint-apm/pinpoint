...
export class ScatterChartForFullScreenModeContainerComponent
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    ...
    this.newUrlStateNotificationService.onUrlStateChange$
      ...
      .subscribe((urlService: NewUrlStateNotificationService) => {
        ...
        this.selectedApplication = this.application = urlService
          .getPathValue(UrlPathId.APPLICATION)
          .getKeyStr();
        this.selectedAgent = urlService.hasValue(UrlPathId.AGENT_ID)
  ...
  onHideSetting(): void {
    this.renderer.setStyle(
      this.layerBackground.nativeElement,
      'display',
      'none'
    );
