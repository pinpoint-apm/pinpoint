...
export class AgentJVMNonHeapChartContainer implements IInspectorChartContainer {
    private apiUrl = 'api/getAgentStat/jvmGc/chart';
    ...
    makeDataOption(): Data {
        const alpha1 = this.inspectorChartThemeService.getAlpha(0.4);
        const alpha2 = this.inspectorChartThemeService.getAlpha(0.3);
