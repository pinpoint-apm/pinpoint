...
Raphael = function () {
    ...
    if (l.type == "VML") {
        ...
        if (!(da && typeof da.adj == "object"))return l.type = null;
        da = null
    }
    ...
    l.rgb2hsb = function (a, b, c) {
        ...
        d = f;
        if (e == f)return{h:0, s:0, b:f, toString:Ta}; else {
            var g = f - e;
            e = g / f;
    ...
    l.getRGB = Z(function (a) {
        if (!a || (a = D(a)).indexOf("-") + 1)return{r:-1, g:-1, b:-1, hex:"none", error:1};
    ...
    function va(a) {
        var b = [];
        if (!l.is(a, U) || !l.is(a && a[0], U))a = l.parsePathString(a);
        for (var c =
            0, d = a[o]; c < d; c++) {
            b[c] = [];
            ...
            if (j[0] != fa.call(j[0])) {
                ...
                switch (i[0]) {
                    ...
                    case "m":
                        ...
                        e = j[2];
                    default:
                        for (var m = 1, n = j[o]; m < n; m++)i[m] = +(j[m] - (m % 2 ? c : d)).toFixed(3)
                }
            } else {
                b[g] = [];
                if (j[0] == "m") {
            ...
            if (j[0] != sa.call(j[0])) {
                ...
                switch (i[0]) {
                    ...
                    case "M":
                        ...
                        e = +j[2] + d;
                    default:
                        for (var m = 1, n = j[o]; m < n; m++)i[m] = +j[m] + (m % 2 ? c : d)
                }
            } else {
                m = 0;
                for (n = j[o]; m < n; m++)b[g][m] = j[m]
            }
            switch (i[0]) {
                case "Z":
                    c = f;
    ...
    function Xa(a, b, c, d) {
        if (l.is(a,
            ...
            if (a.tagName)return b == null ? {container:a, width:a.style.pixelWidth || a.offsetWidth, height:a.style.pixelHeight || a.offsetHeight} : {container:a, width:b, height:c}
    ...
    if (l.svg) {
        ...
        var db = function (a, b) {
            ...
            function g(k, t) {
                if (t = c[fa.call(t)]) {
                    ...
                    for (var B = [], w = t[o]; w--;)B[w] = t[w] * L + (w % 2 ? 1 : -1) * k;
            ...
            y(e) && a.rotate(0, true);
            for (var i in b)if (b[z](i))if (ta[z](i)) {
                var j = b[i];
                f[i] = j;
                switch (i) {
                    case "blur":
                    ...
                    case "clip-rect":
                        ...
                        break;
                    case "path":
                        if (a.type == "path")u(d, {d:j ? (f.path = oa(j)) : "M0,0"});
                        break;
                    case "width":
                        d[W](i, j);
                        if (f.fx) {
            ...
            Db(a, b);
            if (h)a.rotate(h.join(N)); else y(e) && a.rotate(e, true)
            ...
            if (!(a.type != "text" || !(b[z]("text") || b[z]("font") || b[z]("font-size") || b[z]("x") || b[z]("y")))) {
                ...
                if (b[z]("text")) {
                    ...
                    e = 0;
                    for (g = b[o]; e < g; e++)e && u(b[e], {dy:f * eb, x:c.x})
                }
                u(d, {y:c.y});
                a = a.getBBox();
        ...
        s[p].rotate = function (a, b, c) {
            if (this.removed)return this;
            if (a == null) {
                if (this._.rt.cx)return[this._.rt.deg, this._.rt.cx, this._.rt.cy][R](N);
                return this._.rt.deg
            }
            var d = this.getBBox();
            a = D(a)[G](V);
        ...
        s[p].attr = function (a, b) {
            ...
            if (b == null && l.is(a, ga)) {
                if (a == "translation")return Aa.call(this);
                if (a == "rotation")return this.rotate();
                if (a == "scale")return this.scale();
                if (a == ca && this.attrs.fill == "none" && this.attrs.gradient)return this.attrs.gradient;
                return this.attrs[a]
            }
            if (b == null && l.is(a, U)) {
                b = {};
            ...
            if (b != null) {
                ...
                c[a] = b;
                ea(this, c)
            } else a != null && l.is(a, "object") && ea(this, a);
            return this
        };
        ...
        var fb = function (a, b, c, d) {
            ...
            Ca = function () {
                ...
                if (b == 1) {
                    ...
                    C.body[x](e)
                } else b.firstChild ? b.insertBefore(e, b.firstChild) : b[x](e);
                b = new H;
                b.width = f;
                b.height = a;
                b.canvas = e;
        ...
        H[p].clear = function () {
            for (var a =
                this.canvas; a.firstChild;)a.removeChild(a.firstChild);
            this.bottom = this.top = null;
    ...
    if (l.vml) {
        var lb = {M:"m", L:"l", C:"c", Z:"x", m:"t", l:"r", c:"v", z:"x"}, Eb = /([clmz]),?([^clmz]*)/gi, Fb = /-?[^,\s-]+/g, qa = 1000 + N + 1000, na = 10, ra = {path:1, rect:1}, Gb = function (a) {
            ...
            D(a).match(b) && (c = wa);
            b = /[clmz]/g;
            if (c == oa && !D(a).match(b))return a = D(a)[I](Eb, function (i, j, m) {
            ...
            for (var f = 0, e = b[o]; f < e; f++) {
                ...
                d = fa.call(b[f][0]);
                d == "z" && (d = "x");
                for (var g = 1, h = c[o]; g < h; g++)d += Q(c[g] * na) + (g != h - 1 ? "," : A);
                a[F](d)
            }
            return a[R](N)
        };
        ...
        ea = function (a, b) {
            ...
            if (b.path && a.type == "path" || e)c.path = Gb(d.path);
            ...
            if (b.opacity != null || b["stroke-width"] != null || b.fill != null || b.stroke != null || b["stroke-width"] != null || b["stroke-opacity"] != null || b["fill-opacity"] != null || b["stroke-dasharray"] != null || b["stroke-miterlimit"] != null || b["stroke-linejoin"] != null || b["stroke-linecap"] != null) {
                ...
                if (f.on && b.fill)if (a = b.fill.match(Sa)) {
                    f.src = a[1];
                    f.type = "tile"
                } else {
                ...
                if (b.stroke && b.stroke != "none" ||
                    b["stroke-width"] || b["stroke-opacity"] != null || b["stroke-dasharray"] || b["stroke-miterlimit"] || b["stroke-linejoin"] || b["stroke-linecap"])f.on = true;
        ...
        pa = function (a, b) {
            ...
            if (e[o]) {
                ...
                a = [];
                for (var g = 0, h = e[o]; g < h; g++)e[g].offset && a[F](e[g].offset + N + e[g].color);
        ...
        s[p].getBBox = function () {
            if (this.removed)return this;
            if (ra[z](this.type))return xa(this.attrs.path);
            return{x:this.X + (this.bbx || 0), y:this.Y, width:this.W, height:this.H}
        };
        s[p].remove = function () {
            if (!this.removed) {
        ...
        s[p].attr = function (a, b) {
            ...
            if (d) {
                ...
                ea(this, d);
                if (d.gradient && ({circle:1, ellipse:1}[z](this.type) || D(d.gradient).charAt() != "r"))pa(this, d.gradient);
        ...
        s[p].insertAfter = function (a) {
            if (this.removed)return this;
            if (a.constructor == X)a = a[a.length];
    ...
    var Mb = function () {
        if (C.addEventListener)return function (a, b, c, d) {
            ...
            function e(g) {
                if (Da && Ea[z](b))for (var h = 0, i = g.targetTouches && g.targetTouches.length; h < i; h++)if (g.targetTouches[h].target == a) {
                    i = g;
                    g = g.targetTouches[h];
                    g.originalEvent = i;
                    g.preventDefault = Jb;
    ...
    function Ka(a) {
        for (var b = a.clientX, c = a.clientY, d, f = $.length; f--;) {
            d = $[f];
            if (Da)for (var e = a.touches.length, g; e--;) {
                g = a.touches[e];
    ...
    s[p].scale = function (a, b, c, d) {
        if (this.removed)return this;
        if (a == null && b == null)return{x:this._.sx,
        ...
        if (a != 0) {
                    ...
                    for (var t = true, L = 0, B = i[o]; L < B; L++) {
                        ...
                        if (!(J == "M" && t)) {
                            ...
                            if (J == "A") {
                                ...
                                J = 1;
                                for (var ia = w[o]; J < ia; J++)w[J] *= f
                            } else if (J == "V") {
                                J = 1;
                                for (ia = w[o]; J < ia; J++)w[J] *= e
                            } else {
                                J = 1;
                                for (ia = w[o]; J < ia; J++)w[J] *= J % 2 ? f : e
                            }
                        }
                    }
                    e = xa(i);
            ...
            if (this.type in
            {text:1, image:1} && (h != 1 || m != 1))if (this.transformations) {
    ...
    s[p].getPointAtLength = function (a) {
        if (this.type == "path") {
            if (this.node.getPointAtLength)return this.node.getPointAtLength(a);
            return Ba(this.attrs.path, a)
        }
    };
    s[p].getSubpath = function (a, b) {
        if (this.type == "path") {
            if (v.abs(this.getTotalLength() - b) < 1.0E-6)return Na(this.attrs.path, a).end;
    ...
    function qb() {
        var a = +new Date;
        for (var b in T)if (b != "length" && T[z](b)) {
            var c =
                T[b];
                        ...
                        switch (Ga[t]) {
                            ...
                            case "path":
                                ...
                                for (var L = g[t][o]; e < L; e++) {
                                    k[e] = [g[t][e][0]];
                                    for (var B = 1, w = g[t][e][o]; B < w; B++)k[e][B] = +g[t][e][B] + r * f * h[t][e][B];
                                    k[e] = k[e][R](N)
                                }
                                k = k[R](N);
                                break;
    ...
    function Aa(a, b) {
        if (a == null)return{x:this._.tx, y:this._.ty, toString:nb};
        this._.tx += +a;
        this._.ty += +b;
        switch (this.type) {
            case "circle":
    ...
    s[p].animate = function (a, b, c, d) {
        if (l.is(c, "function") || !c)d = c || null;
        var f = {}, e = {}, g = {};
        for (var h in a)if (a[z](h))if (Ga[z](h)) {
            f[h] = this.attr(h);
            f[h] == null && (f[h] = ta[h]);
            e[h] = a[h];
            switch (Ga[h]) {
    ...
    function X(a) {
        ...
        this[o] = 0;
        this.type = "set";
        if (a)for (var b = 0, c = a[o]; b < c; b++)if (a[b] && (a[b].constructor == s || a[b].constructor == X)) {
    ...
    for (var Pa in s[p])if (s[p][z](Pa))X[p][Pa] = function (a) {
        return function () {
    ...
    X[p].clone = function (a) {
        a = new X;
        for (var b = 0, c = this.items[o]; b < c; b++)a[F](this.items[b].clone());
        return a
    };
    l.registerFont = function (a) {
        ...
        if (this.fonts[c])this.fonts[c][F](b); else this.fonts[c] = [b];
        if (!a.svg) {
    ...
    H[p].getFont = function (a, b, c, d) {
        ...
        if (l.fonts) {
            ...
            if (!f) {
                ...
                for (var e in l.fonts)if (l.fonts[z](e))if (a.test(e)) {
                    f =
                        l.fonts[e];
                    break
                }
