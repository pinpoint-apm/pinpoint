...
@Configuration
@Import(BatchApplicationIndexServiceConfig.class)
public class BatchServiceConfig {

    @Bean
    public BatchAgentService batchAgentService(
            ActiveAgentValidator activeAgentValidator,
            BatchApplicationIndexService batchApplicationIndexService) {
        return new BatchAgentServiceImpl(activeAgentValidator, batchApplicationIndexService);
    }
}
