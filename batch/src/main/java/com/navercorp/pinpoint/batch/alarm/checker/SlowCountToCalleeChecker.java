...
public class SlowCountToCalleeChecker extends LongValueAlarmChecker {
    ...
    public SlowCountToCalleeChecker(MapOutLinkDataCollector dataCollector, Rule rule) {
    ...
    protected Long getDetectedValue() {
        ...
        return ((MapOutLinkDataCollector)dataCollector).getCount(inLinkName, DataCategory.SLOW_COUNT);
    }
