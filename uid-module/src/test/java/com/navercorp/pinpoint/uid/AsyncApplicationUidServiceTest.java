...
import com.navercorp.pinpoint.uid.service.ApplicationUidServiceImpl;
import com.navercorp.pinpoint.uid.service.async.AsyncApplicationUidService;
import com.navercorp.pinpoint.uid.service.async.AsyncApplicationUidServiceImpl;
...
public class AsyncApplicationUidServiceTest {
    ...
    public static void setUp() {
        ...
        applicationUidService = new ApplicationUidServiceImpl(applicationUidDao, applicationNameDao, new RandomApplicationUidGenerator());
        asyncApplicationUidService = new AsyncApplicationUidServiceImpl(applicationUidDao, applicationNameDao, new RandomApplicationUidGenerator());
    }
