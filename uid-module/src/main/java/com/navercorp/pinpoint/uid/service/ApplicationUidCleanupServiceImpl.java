...
@Service
public class ApplicationUidCleanupServiceImpl implements ApplicationUidCleanupService {
    ...
    public ApplicationUidCleanupServiceImpl(AgentNameService agentNameService, ApplicationUidService applicationUidService,
