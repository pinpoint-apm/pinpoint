...
//    API_ID(11, "API-ID"),
    ...
    AnnotationKey MONGO_JSON = AnnotationKeyFactory.of(51, "MONGO_JSON");
    AnnotationKey MONGO_COLLECTIONINFO = AnnotationKeyFactory.of(52, "Collection-Info", VIEW_IN_RECORD_SET);
    AnnotationKey MONGO_JSON_BINDVALUE = AnnotationKeyFactory.of(54, "JSON-BindValue", VIEW_IN_RECORD_SET);
