 ...
 * <tr><td>8670</td><td>PULSAR_CLIENT</td></tr>
 * <tr><td>8671</td><td>PULSAR_CLIENT_INTERNAL</td></tr>
 * </table>
 *
...
//    ServiceType SPRING_BEAN = of(5071, "SPRING_BEAN", "SPRING_BEAN", NORMAL_SCHEMA);
    ...
    ServiceType OPENTELEMETY_SERVER = of(1220, "OPENTELEMETRY_SERVER", "OPENTELEMETRY_SERVER", RECORD_STATISTICS);
    ServiceType OPENTELEMETY_INTERNAL = of(1221, "OPENTELEMETRY_INTERNAL", "OPENTELEMETRY_INTERNAL");
    ServiceType OPENTELEMETY_DB = of(2060, "OPENTELEMETRY_DB", "OPENTELEMETRY_DB", RECORD_STATISTICS);
    ServiceType OPENTELEMETY_DB_EXECUTE_QUERY = of(2061, "OPENTELEMETY_DB_EXECUTE_QUERY", "OPENTELEMETY_DB", TERMINAL, RECORD_STATISTICS, INCLUDE_DESTINATION_ID);
    ServiceType OPENTELEMETY_CLIENT = of(9310, "OPENTELEMETRY_CLIENT", "OPENTELEMETRY_CLIENT", RECORD_STATISTICS);
}
