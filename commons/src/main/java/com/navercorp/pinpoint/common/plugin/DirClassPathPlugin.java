 ...
 */
public class DirClassPathPlugin<T> implements Plugin<T> {
    private final URL pluginUrl;

    private final List<T> instanceList;
    private final List<String> packageList;

    public DirClassPathPlugin(URL pluginUrl, List<T> instanceList, List<String> packageList) {
