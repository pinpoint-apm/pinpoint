...
public class ParsedTraceMetadataProvider implements TraceMetadataProvider {
    ...
    public ParsedTraceMetadataProvider(String pluginJarName, List<ServiceTypeInfo> serviceTypeInfos, List<AnnotationKey> annotationKeys) {
    ...
    public void setup(TraceMetadataSetupContext context) {
        for (ServiceTypeInfo serviceTypeInfo : serviceTypeInfos) {
            ...
            ServiceTypeProvider.register(serviceType);
        }
