...
package com.navercorp.pinpoint.it.plugin.thrift.common.server;
...
import com.navercorp.pinpoint.it.plugin.thrift.common.client.SyncEchoTestClient;
...
public abstract class AsyncEchoTestServer<T extends AbstractNonblockingServer> extends ThriftEchoTestServer<T> {
    ...
    public void verifyServerTraces(PluginTestVerifier verifier) throws Exception {
        ...
        verifier.verifyTrace(root("THRIFT_SERVER", // ServiceType,
                ...
                "com/navercorp/pinpoint/it/plugin/thrift/dto/EchoService/echo", // rpc
                HostAndPort.toHostAndPortString(address, socketAddress.getPort()), // endPoint
                address // remoteAddress
        ));
        // SpanEvent - TBaseAsyncProcessor.process
        verifier.verifyTrace(event("THRIFT_SERVER_INTERNAL", process, annotation("thrift.url", "com/navercorp/pinpoint/it/plugin/thrift/dto/EchoService/echo")));
    }
