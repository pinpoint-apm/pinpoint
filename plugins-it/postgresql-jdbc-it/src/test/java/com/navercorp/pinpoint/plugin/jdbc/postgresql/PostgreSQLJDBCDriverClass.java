 ...
 * @author Taejin Koo
 */
public class PostgreSQLJDBCDriverClass extends AbstractJDBCDriverClass {

    public PostgreSQLJDBCDriverClass() {
        super();
    }
    ...
    public Class<PreparedStatement> getPreparedStatement() {
        return forName("org.postgresql.jdbc.PgPreparedStatement");
    }
