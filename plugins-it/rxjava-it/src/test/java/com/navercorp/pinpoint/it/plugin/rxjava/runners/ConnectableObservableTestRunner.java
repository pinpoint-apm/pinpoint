...
public class ConnectableObservableTestRunner {
    ...
    static final String INTERNAL_METHOD = "INTERNAL_METHOD";
    ...
    public void connectableObservable() throws Exception {
        ...
        for (int i = 0; i < numSubscribers; i++) {
            verifier.verifyTrace(event(INTERNAL_METHOD, echoMethod));
        }
    }
    ...
    public void connectableObservableError() throws Exception {
        ...
        verifier.verifyTrace(event(INTERNAL_METHOD, echoMethod, expected));
    }
}
