...
import bb, { bar, ChartOptions } from 'billboard.js';
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import BillboardJS, { IChart } from '@billboard.js/react';
import { abbreviateNumber, getEllipsisText } from '@pinpoint-fe/utils';
import { format, isValid } from 'date-fns';
import { SqlStatChart as SqlStatChartApi } from '@pinpoint-fe/constants';
import { cn } from '../../../lib';

export interface SqlStatTotalCountChartProps {
...
export const SqlStatTotalCountChart = ({
  data,
  className,
  emptyMessage = 'No Data',
}: SqlStatTotalCountChartProps) => {
