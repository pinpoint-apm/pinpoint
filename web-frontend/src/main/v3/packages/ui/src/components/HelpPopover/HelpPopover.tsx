...
const components = {
  FaCircle: <FaCircle key="FaCircle" />,
  FaPlus: <FaPlus key="FaPlus" />,
  FaDownload: <FaDownload key="FaDownload" />,
  FaExpandArrowsAlt: <FaExpandArrowsAlt key="FaExpandArrowsAlt" />,
  BsGearFill: <BsGearFill key="BsGearFill" />,
  BiSolidServer: <BiSolidServer key="BiSolidServer" />,
  PiHardDriveFill: <PiHardDriveFill key="PiHardDriveFill" />,
  FaArrowAltCircleDown: <FaArrowAltCircleDown key="FaArrowAltCircleDown" />,
  FaTimesCircle: <FaTimesCircle key="FaTimesCircle" />,
  FaExclamationCircle: <FaExclamationCircle key="FaExclamationCircle" />,
  FaSmileBeam: <FaSmileBeam key="FaSmileBeam" />,
  FaSmile: <FaSmile key="FaSmile" />,
  FaMeh: <FaMeh key="FaMeh" />,
  FaFrown: <FaFrown key="FaFrown" />,
