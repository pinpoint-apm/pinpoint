...
export const SERVER_MAP_DATA_V2 = `${LOCAL_API_PATH}/servermap/getServerMapDataV2`;
...
export const FILTERED_SERVER_MAP_DATA = `${LOCAL_API_PATH}/servermap/getFilteredServerMapDataMadeOfDotGroup`;
