...
@Component({
    selector: 'pp-load-avg-max-chart',
    templateUrl: './load-avg-max-chart.component.html',
    styleUrls: ['./load-avg-max-chart.component.css']
})
export class LoadAvgMaxChartComponent implements OnInit, OnChanges {
