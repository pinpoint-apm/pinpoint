...
public class ApdexDataCollector implements PinotDataCollector<Double> {
    ...
    public ApdexDataCollector(String tenantId, UriStatDao uriStatDao) {
    ...
    public Double collect(String serviceName, String applicationName, String targetUri, Range range) {
        ...
        return uriStatDao.selectApdex(params);
    }
}
