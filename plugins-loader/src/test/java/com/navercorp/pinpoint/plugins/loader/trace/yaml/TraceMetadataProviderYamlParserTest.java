...
public class TraceMetadataProviderYamlParserTest {
    ...
    private static final String validTypeProviderDefEntry = "type-provider/valid.yml";

    @Test
    public void parseValid() {
        TraceMetadataProviderParser parser = new TraceMetadataProviderYamlParser(validTypeProviderDefEntry);
        List<TraceMetadataProvider> traceMetadataProviders = parser.parse(ClassLoader.getSystemClassLoader());

        TraceMetadataProviderVerifier verifier = new TraceMetadataProviderVerifier(traceMetadataProviders);
    ...
    private static class TraceMetadataProviderVerifier {
        ...
        private TraceMetadataProviderVerifier(List<TraceMetadataProvider> traceMetadataProviders) {
