...
public class DefaultTimeSeriesView implements TimeSeriesView {
    private final String title;
    private final List<Long> timestamp;
    private final List<TimeseriesValueGroupView> metricValueGroups;

    public DefaultTimeSeriesView(String title, List<Long> timestamp, List<TimeseriesValueGroupView> metricValueGroups) {
