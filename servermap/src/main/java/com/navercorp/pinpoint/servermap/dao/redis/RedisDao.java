...
import com.navercorp.pinpoint.redis.timeseries.ArrayTimestampValueOutput;
import com.navercorp.pinpoint.redis.timeseries.RedisTimeseriesAsyncCommands;
import com.navercorp.pinpoint.redis.timeseries.RedisTimeseriesCommands;
...
public class RedisDao {
    ...
    public List<DirectionalBo> readData() {
        ...
        for (String key : keys) {
            ...
            try {
                ...
                bos.add(toInboundDataBo(key, pairs));
            } catch (Exception e) {
    ...
    public DirectionalBo toInboundDataBo(String key, List<TimestampValuePair> pairs) {
