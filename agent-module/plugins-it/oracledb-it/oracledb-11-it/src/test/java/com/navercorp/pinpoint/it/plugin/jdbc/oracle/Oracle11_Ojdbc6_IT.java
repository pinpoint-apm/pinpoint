...
@Dependency({"com.oracle.database.jdbc:ojdbc6:[11.2.0.4]"})
@SharedDependency({"com.oracle.database.jdbc:ojdbc6:11.2.0.4", TestcontainersOption.TEST_CONTAINER, OracleITConstants.ORACLE_TESTCONTAINER_15_3})
