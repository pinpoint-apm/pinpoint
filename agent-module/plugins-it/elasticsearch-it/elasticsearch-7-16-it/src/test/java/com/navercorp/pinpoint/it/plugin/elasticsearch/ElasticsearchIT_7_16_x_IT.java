...
@Dependency({"org.elasticsearch.client:elasticsearch-rest-high-level-client:[7.16.0]", PluginITConstants.VERSION})
@SharedDependency({TestcontainersOption.ELASTICSEARCH, PluginITConstants.VERSION})
