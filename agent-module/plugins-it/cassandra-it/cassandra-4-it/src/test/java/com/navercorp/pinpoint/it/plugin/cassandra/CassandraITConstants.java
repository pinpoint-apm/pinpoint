...
public final class CassandraITConstants {
    ...
    public static final String CASSANDRA_TESTCONTAINER = "org.testcontainers:testcontainers-cassandra:" + TestcontainersOption.VERSION;

    // https://hub.docker.com/_/cassandra
    public static final String CASSANDRA_3_X_IMAGE = "cassandra:3.11.19";
