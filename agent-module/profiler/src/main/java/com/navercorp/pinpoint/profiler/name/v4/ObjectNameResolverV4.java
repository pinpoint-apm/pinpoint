...
public class ObjectNameResolverV4 implements ObjectNameResolver {
    ...
    public ObjectName resolve() {
        ...
        if (!applicationName.hasLengthValue()) {
            ...
            throw new ObjectNameValidationFailedException("ApplicationName not provided");
        }  else {
        ...
        if (!serviceName.hasLengthValue()) {
            ...
            throw new ObjectNameValidationFailedException("ServiceName not provided");
        } else {
        ...
        if (!apiKey.hasLengthValue()) {
            ...
            throw new ObjectNameValidationFailedException("ApiKey not provided");
        } else {
            resolveLog(apiKey);
        }
