...
/**
 * Guard codegen switched off: every interceptor takes the shared wrapper.
 */
public final class DisableGuardedInterceptorFactory implements GuardedInterceptorFactory {
    ...
    public String toString() {
        return "DisableGuardedInterceptorFactory";
    }
}
