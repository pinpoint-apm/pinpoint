...
public class DoubleGaugeMetricVo extends AbstractCustomMetricVo {
    ...
    public DoubleGaugeMetricVo(DoubleGaugeWrapper doubleGaugeMetricWrapper) {
        super(doubleGaugeMetricWrapper);
        this.value = doubleGaugeMetricWrapper.getValue();
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("DoubleGaugeMetricVo{");
