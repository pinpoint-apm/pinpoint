...
public class SpanBatchGrpcDataSenderProvider implements Provider<DataSender<SpanType>> {
    ...
    public DataSender<SpanType> get() {
        ...
        final int batchSize = grpcTransportConfig.getSpanSenderBatchSize();
        final long flushIntervalMillis = grpcTransportConfig.getSpanSenderBatchFlushIntervalMillis();
        final long batchCollectDeadLineTimeMillis = grpcTransportConfig.getSpanSenderBatchCollectDeadLineTimeMillis();
