...
public class ExceptionHandleScopedInjectedAsyncContextApiIdAwareAroundInterceptor implements InjectedAsyncContextApiIdAwareAroundInterceptor {
    ...
    public ExceptionHandleScopedInjectedAsyncContextApiIdAwareAroundInterceptor(InjectedAsyncContextApiIdAwareAroundInterceptor delegate, InterceptorScope scope, ExecutionPolicy policy, ExceptionHandler exceptionHandler) {
