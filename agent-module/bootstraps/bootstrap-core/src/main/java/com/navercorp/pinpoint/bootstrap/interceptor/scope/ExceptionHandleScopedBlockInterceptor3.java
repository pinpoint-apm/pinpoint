...
public class ExceptionHandleScopedBlockInterceptor3 implements BlockAroundInterceptor3 {
    private final PluginLogger logger = PluginLogManager.getLogger(getClass());
    private final boolean debugEnabled = logger.isDebugEnabled();

    private final BlockAroundInterceptor3 interceptor;
    private final InterceptorScope scope;
    private final ExecutionPolicy policy;
    private final ExceptionHandler exceptionHandler;

    public ExceptionHandleScopedBlockInterceptor3(BlockAroundInterceptor3 interceptor, InterceptorScope scope, ExecutionPolicy policy, ExceptionHandler exceptionHandler) {
    ...
    public TraceBlock before(Object target, Object arg0, Object arg1, Object arg2) {
        ...
        if (transaction.tryEnter(policy)) {
            try {
                return interceptor.before(target, arg0, arg1, arg2);
            } catch (Throwable t) {
    ...
    public void after(TraceBlock block, Object target, Object arg0, Object arg1, Object arg2, Object result, Throwable throwable) {
        ...
        if (transaction.canLeave(policy)) {
            try {
                this.interceptor.after(block, target, arg0, arg1, arg2, result, throwable);
            } catch (Throwable t) {
                exceptionHandler.handleException(t);
            } finally {
