...
public class ExceptionHandleScopedBlockApiIdAwareAroundInterceptor implements BlockApiIdAwareAroundInterceptor {
    ...
    public ExceptionHandleScopedBlockApiIdAwareAroundInterceptor(BlockApiIdAwareAroundInterceptor delegate, InterceptorScope scope, ExecutionPolicy policy, ExceptionHandler exceptionHandler) {
