...
public class ScopedBlockInterceptor implements BlockAroundInterceptor {
    ...
    public ScopedBlockInterceptor(BlockAroundInterceptor interceptor, InterceptorScope scope, ExecutionPolicy policy) {
