...
/**
 * Same trace flow as {@link AsyncContextSpanEventNestedApiIdAwareAroundInterceptor}, but the
 * {@link AsyncContext} is received as a method argument (read monomorphically by the weaver) instead
 * of being resolved via the megamorphic {@code getAsyncContext(target)} call. See
 * {@link InjectedAsyncContextApiIdAwareAroundInterceptor}.
 */
public abstract class InjectedAsyncContextSpanEventNestedApiIdAwareAroundInterceptor extends AbstractAsyncContextSpanEventInterceptor implements InjectedAsyncContextApiIdAwareAroundInterceptor {

    private final String traceScopeName;

    public InjectedAsyncContextSpanEventNestedApiIdAwareAroundInterceptor(TraceContext traceContext, String traceScopeName) {
        this(traceContext, traceScopeName, true);
    }

    public InjectedAsyncContextSpanEventNestedApiIdAwareAroundInterceptor(TraceContext traceContext, String traceScopeName, boolean asyncTraceBlock) {
