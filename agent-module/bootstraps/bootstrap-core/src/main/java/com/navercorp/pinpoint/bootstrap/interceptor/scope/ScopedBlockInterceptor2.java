...
public class ScopedBlockInterceptor2 implements BlockAroundInterceptor2 {
    ...
    public ScopedBlockInterceptor2(BlockAroundInterceptor2 interceptor, InterceptorScope scope, ExecutionPolicy policy) {
