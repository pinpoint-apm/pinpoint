...
public class ScopedInjectedAsyncContextApiIdAwareAroundInterceptor implements InjectedAsyncContextApiIdAwareAroundInterceptor {
    ...
    public ScopedInjectedAsyncContextApiIdAwareAroundInterceptor(InjectedAsyncContextApiIdAwareAroundInterceptor delegate, InterceptorScope scope, ExecutionPolicy policy) {
