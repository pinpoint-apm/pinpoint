...
public class ScopedBlockInterceptor4 implements BlockAroundInterceptor4 {
    ...
    public ScopedBlockInterceptor4(BlockAroundInterceptor4 interceptor, InterceptorScope scope, ExecutionPolicy policy) {
