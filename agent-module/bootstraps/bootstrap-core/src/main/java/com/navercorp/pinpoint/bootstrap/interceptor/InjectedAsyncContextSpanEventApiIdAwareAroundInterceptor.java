...
/**
 * Same trace flow as {@link AsyncContextSpanEventApiIdAwareAroundInterceptor}, but the
 ...
 */
public abstract class InjectedAsyncContextSpanEventApiIdAwareAroundInterceptor extends AbstractAsyncContextSpanEventInterceptor implements InjectedAsyncContextApiIdAwareAroundInterceptor {
    public InjectedAsyncContextSpanEventApiIdAwareAroundInterceptor(TraceContext traceContext) {
        this(traceContext, true);
    }

    public InjectedAsyncContextSpanEventApiIdAwareAroundInterceptor(TraceContext traceContext, boolean asyncTraceBlock) {
