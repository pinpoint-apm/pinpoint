...
public class ScopedBlockInterceptor3 implements BlockAroundInterceptor3 {
    ...
    public ScopedBlockInterceptor3(BlockAroundInterceptor3 interceptor, InterceptorScope scope, ExecutionPolicy policy) {
    ...
    public void after(TraceBlock block, Object target, Object arg0, Object arg1, Object arg2, Object result, Throwable throwable) {
        ...
        if (transaction.canLeave(policy)) {
            try {
                interceptor.after(block, target, arg0, arg1, arg2, result, throwable);
            } finally {
