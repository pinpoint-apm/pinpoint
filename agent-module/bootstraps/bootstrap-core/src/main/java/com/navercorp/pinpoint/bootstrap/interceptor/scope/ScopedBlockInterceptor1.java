...
public class ScopedBlockInterceptor1 implements BlockAroundInterceptor1 {
    ...
    public ScopedBlockInterceptor1(BlockAroundInterceptor1 interceptor, InterceptorScope scope, ExecutionPolicy policy) {
    ...
    public void after(TraceBlock block, Object target, Object arg0, Object result, Throwable throwable) {
        ...
        if (transaction.canLeave(policy)) {
            try {
                interceptor.after(block, target, arg0, result, throwable);
            } finally {
