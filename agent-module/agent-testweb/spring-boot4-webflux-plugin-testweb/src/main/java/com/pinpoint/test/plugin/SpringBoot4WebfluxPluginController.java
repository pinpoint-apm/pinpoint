...
@RestController
public class SpringBoot4WebfluxPluginController {

    private final RequestMappingHandlerMapping handlerMapping;

    @Autowired
    public SpringBoot4WebfluxPluginController(RequestMappingHandlerMapping handlerMapping) {
    ...
    public String welcome() {
        ...
        return new ApiLinkPage("spring-boot4-webflux-plugin-testweb")
                .addHrefTag(list)
                .build();
    }
    ...
    @GetMapping("/client/exchangeToMono")
    public Mono<String> clientExchangeToMono() {
        WebClient client = WebClient.create("http://localhost:18080");
    ...
    @GetMapping(value = "/client/exchangeToFlux", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public Flux<String> clientExchangeToFlux() {
        WebClient client = WebClient.create("http://localhost:18080");
        return client.method(HttpMethod.GET)
                .uri("/server/welcome")
    ...
    public Mono<String> testExchange(@RequestBody String body) {
        ...
        Mono<ClientResponse> response = exchangeFunction.exchange(ClientRequest.create(
