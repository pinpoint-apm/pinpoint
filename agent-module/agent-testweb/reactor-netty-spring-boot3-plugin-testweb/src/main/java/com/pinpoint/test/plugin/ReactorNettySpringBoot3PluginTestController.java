...
/**
 * Test controller for reactor-netty plugin with Spring Boot 3.x (reactor-netty 1.1.x+)
 */
@RestController
public class ReactorNettySpringBoot3PluginTestController {
    ...
    @ResponseBody
    public String clientPostBody(@RequestBody String body) {
        return "OK";
    }
}
