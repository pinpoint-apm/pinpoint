 ...
 * @author jaehong.kim
 */
public class HttpClientResponseImplInterceptor extends AsyncContextSpanEventApiIdAwareAroundInterceptor {
    public HttpClientResponseImplInterceptor(TraceContext traceContext) {
        super(traceContext);
    }
