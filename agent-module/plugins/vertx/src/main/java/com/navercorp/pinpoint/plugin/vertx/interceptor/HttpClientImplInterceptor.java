 ...
 * @author jaehong.kim
 */
public class HttpClientImplInterceptor extends SpanEventApiIdAwareAroundInterceptorForPlugin {
    public HttpClientImplInterceptor(TraceContext traceContext) {
        super(traceContext);
    }
