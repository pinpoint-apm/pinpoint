...
package com.navercorp.pinpoint.plugin.pekko.http.interceptor;
...
import com.navercorp.pinpoint.plugin.pekko.http.HttpRequestAdaptor;
import com.navercorp.pinpoint.plugin.pekko.http.PekkoHttpConfig;
import com.navercorp.pinpoint.plugin.pekko.http.PekkoHttpConstants;
...
public class DirectivesInterceptor implements ApiIdAwareAroundInterceptor {
    ...
    private static final PekkoHttpServerMethodDescriptor PEKKO_HTTP_SERVER_METHOD_DESCRIPTOR = new PekkoHttpServerMethodDescriptor();
    ...
    public DirectivesInterceptor(final TraceContext traceContext, final RequestRecorderFactory<HttpRequest> requestRecorderFactory) {
        ...
        final PekkoHttpConfig config = new PekkoHttpConfig(traceContext.getProfilerConfig());
        ...
        traceContext.cacheApi(PEKKO_HTTP_SERVER_METHOD_DESCRIPTOR);
    }
    ...
    public void before(Object target, int apiId, Object[] args) {
        ...
        org.apache.pekko.http.scaladsl.model.HttpRequest request = requestContext.request();
        ...
        recorder.recordServiceType(PekkoHttpConstants.PEKKO_HTTP_SERVER_INTERNAL);
    ...
    private void recordRootSpan(final SpanRecorder recorder, final HttpRequest request) {
        recorder.recordServiceType(PekkoHttpConstants.PEKKO_HTTP_SERVER);
        ...
        recorder.recordApi(PEKKO_HTTP_SERVER_METHOD_DESCRIPTOR);
    }
