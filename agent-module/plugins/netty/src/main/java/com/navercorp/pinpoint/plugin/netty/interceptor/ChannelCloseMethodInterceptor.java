 ...
 * @author jaehong.kim
 */
public class ChannelCloseMethodInterceptor extends AsyncContextSpanEventEndPointInterceptor {
    public ChannelCloseMethodInterceptor(TraceContext traceContext, MethodDescriptor methodDescriptor) {
