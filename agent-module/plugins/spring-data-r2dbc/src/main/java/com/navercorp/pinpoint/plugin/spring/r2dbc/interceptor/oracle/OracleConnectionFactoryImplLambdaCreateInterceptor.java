...
public class OracleConnectionFactoryImplLambdaCreateInterceptor extends SetDatabaseInfoInterceptor {
    @Override
    ...
    public boolean setDatabaseInfo(DatabaseInfo databaseInfo, Object target, Object[] args, Object result) {
        final DatabaseInfoAccessor databaseInfoAccessor = ArrayArgumentUtils.getArgument(args, 1, DatabaseInfoAccessor.class);
        if (databaseInfoAccessor != null) {
            databaseInfoAccessor._$PINPOINT$_setDatabaseInfo(databaseInfo);
            return true;
        }
        return false;
    }
