...
package com.navercorp.pinpoint.plugin.resttemplate6.interceptor;
...
import com.navercorp.pinpoint.plugin.resttemplate6.RestTemplateConstants;
import com.navercorp.pinpoint.plugin.resttemplate6.RestTemplateResponseHeaderAdaptor;
...
public class ClientHttpResponseInterceptor extends SpanEventSimpleAroundInterceptorForPlugin {
    ...
    @Override
    public void doInAfterTrace(SpanEventRecorder recorder, Object target, Object[] args, Object result, Throwable throwable) throws IOException {
        recorder.recordApi(methodDescriptor);
        recorder.recordException(throwable);

        if (target instanceof ClientHttpResponse clientHttpResponse) {
