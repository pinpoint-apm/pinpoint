...
public class AsyncHandlerOnStatusReceivedInterceptor extends AsyncContextSpanEventSimpleAroundInterceptor {

    public AsyncHandlerOnStatusReceivedInterceptor(TraceContext traceContext, MethodDescriptor methodDescriptor) {
