 ...
 * {@code org.eclipse.jetty.ee10.servlet.ServletChannel#handle()} and extracts
 * the request/response via direct typed access on the EE10 servlet API.
 */
public class EE10ServletChannelHandleInterceptor extends AbstractServletChannelHandleInterceptor {

    public EE10ServletChannelHandleInterceptor(TraceContext traceContext, RequestRecorderFactory<HttpServletRequest> requestRecorderFactory) {
