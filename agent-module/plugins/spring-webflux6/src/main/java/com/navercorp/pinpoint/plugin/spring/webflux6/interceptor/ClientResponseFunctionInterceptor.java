...
package com.navercorp.pinpoint.plugin.spring.webflux6.interceptor;
...
import com.navercorp.pinpoint.plugin.spring.webflux6.SpringWebFluxConstants;
import com.navercorp.pinpoint.plugin.spring.webflux6.SpringWebFluxResponseHeaderAdaptor;
...
public class ClientResponseFunctionInterceptor extends SpanEventSimpleAroundInterceptorForPlugin {
    ...
    protected void doInAfterTrace(SpanEventRecorder recorder, Object target, Object[] args, Object result, Throwable throwable) {
        ...
        if (args[0] instanceof ClientHttpResponse response) {
