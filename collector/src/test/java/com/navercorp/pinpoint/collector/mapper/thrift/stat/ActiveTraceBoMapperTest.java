 ...
 * @author Taejin Koo
 */
public class ActiveTraceBoMapperTest extends ThriftBoMapperTestBase<TActiveTrace, ActiveTraceBo> {
    ...
    protected ActiveTraceBo convert(TActiveTrace original) {
        ActiveTraceBoMapper activeTraceBoMapper = new ActiveTraceBoMapper();
