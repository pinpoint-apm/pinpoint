...
public class StatServerTestMain {
    ...
    public void run() throws Exception {
        ...
        grpcReceiver.setAddressFilter(address -> true);
    ...
    private ServerServiceDefinition newStatBindableService(Executor executor) {
        ...
        RateLimitClientStreamServerInterceptor rateLimit = new RateLimitClientStreamServerInterceptor("test-stat", bandwidth, Duration.ofSeconds(1));
