...
public class ServiceInfoServiceImpl implements ServiceInfoService {
    ...
    public void insertAgentInfo(AgentInfoBo agent) {
        ...
        ApplicationId applicationId = agent.getApplicationId();

        this.serviceInfoDao.ensurePut(serviceName, serviceId);

        List<ApplicationId> applicationIds = this.serviceInfoDao.getApplications(serviceId);
        if (!applicationIds.contains(applicationId)) {
            this.serviceInfoDao.insertApplicationIntoService(serviceId, applicationId);
        }
    }
