...
public class UidHbaseTemplateConfiguration {
    private final Logger logger = LogManager.getLogger(UidHbaseTemplateConfiguration.class);

    private final HbaseTemplateConfiguration config = new HbaseTemplateConfiguration();

    public UidHbaseTemplateConfiguration() {
        logger.info("Install {}", UidHbaseTemplateConfiguration.class.getSimpleName());
    }
