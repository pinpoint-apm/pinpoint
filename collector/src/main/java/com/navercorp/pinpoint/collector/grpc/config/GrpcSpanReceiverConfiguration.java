...
public class GrpcSpanReceiverConfiguration {
    ...
    public ServerServiceDefinition spanServerServiceDefinition(SimpleHandler<PSpan> spanHandler,
        ...
        spanHandler = simpleHandlerProxy.proxy(spanHandler);
        spanCheckHandler = simpleHandlerProxy.proxy(spanCheckHandler);
    ...
    @Bean
    public SimpleHandlerProxy simpleHandlerProxy(@Qualifier("handlerManager") HandlerManager handlerManager) {
        return new SimpleHandlerProxy(handlerManager);
    }
