...
public class CalleeCompactColumnName implements ColumnName {
    ...
    public CalleeCompactColumnName(short calleeServiceType, String calleeApplicationName, String callHost, short columnSlotNumber) {
    ...
    public boolean equals(Object o) {
        ...
        CalleeCompactColumnName that = (CalleeCompactColumnName) o;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("CalleeCompactColumnName{");
