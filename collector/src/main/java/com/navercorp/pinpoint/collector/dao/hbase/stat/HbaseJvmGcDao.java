 ...
 */
@Repository
public class HbaseJvmGcDao extends DefaultAgentStatDao<JvmGcBo> {

    public HbaseJvmGcDao(HbaseOperations2 hbaseTemplate,
                               TableNameProvider tableNameProvider,
                               AgentStatHbaseOperationFactory operationFactory,
                               AgentStatSerializer<JvmGcBo> serializer) {
        super(AgentStatType.JVM_GC, HbaseTable.AGENT_STAT_VER2, AgentStatBo::getJvmGcBos,
