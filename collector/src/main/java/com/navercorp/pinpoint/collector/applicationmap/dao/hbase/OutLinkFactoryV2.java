...
public class OutLinkFactoryV2 implements OutLinkFactory {
    ...
    @Override
    public ColumnName histogram(String selfAgentId, Vertex outVertex, String outSubLink, short inSlotNumber) {
        return OutLinkV2ColumnName.histogram(selfAgentId, outVertex, outSubLink, inSlotNumber);
    }
