...
public class ApplicationMapService {
    ...
    public void updateBidirectional(
        ...
        updateOutbound(
                requestTime,
                srcServiceId, srcApplicationName, srcServiceType,
                destServiceId, destApplicationName, destServiceType,
    ...
    public void updateInbound(
            long requestTime,
            int srcServiceId, @NotBlank String srcApplicationName, ServiceType srcServiceType,
            int destServiceId, @NotBlank String destApplicationName, ServiceType destServiceType,
    ...
    public void updateSelfResponseTime(
            long requestTime,
            int serviceId, @NotBlank String applicationName, ServiceType applicationServiceType,
            int elapsed, boolean isError
    ) {
        selfDao.received(
                requestTime,
                serviceId, applicationName, applicationServiceType, elapsed, isError
        );
    }
    ...
    public void updateAgentState(
        ...
        selfDao.updatePing(
                requestTime,
                serviceId, applicationName, applicationServiceType, 0, false
        );
    }
