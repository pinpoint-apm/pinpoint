 ...
 * @author Taejin Koo
 */
public class EchoService implements GrpcSimpleCommandService<PCmdEchoResponse> {

    @Override
    public void handle(PinpointGrpcServer pinpointGrpcServer, PCmdEchoResponse message, StreamObserver<Empty> responseObserver) {
