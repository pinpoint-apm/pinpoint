 ...
 */
public class CollectorAppContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public void initialize(ConfigurableApplicationContext configurableApplicationContext) {
        ...
        EnvironmentPostProcessor webEnvironmentPostProcessor = new CollectorEnvironmentPostProcessor("local");
