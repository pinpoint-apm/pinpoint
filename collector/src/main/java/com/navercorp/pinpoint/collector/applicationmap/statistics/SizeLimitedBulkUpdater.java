...
public class SizeLimitedBulkUpdater implements BulkUpdater, BulkState {
    ...
    public SizeLimitedBulkUpdater(BulkUpdater delegate, int limitSize, BulkOperationReporter reporter) {
