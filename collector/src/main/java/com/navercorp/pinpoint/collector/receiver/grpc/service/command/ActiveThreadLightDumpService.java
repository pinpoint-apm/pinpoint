 ...
 * @author Taejin Koo
 */
public class ActiveThreadLightDumpService implements GrpcSimpleCommandService<PCmdActiveThreadLightDumpRes> {

    @Override
    public void handle(PinpointGrpcServer pinpointGrpcServer, PCmdActiveThreadLightDumpRes message, StreamObserver<Empty> responseObserver) {
