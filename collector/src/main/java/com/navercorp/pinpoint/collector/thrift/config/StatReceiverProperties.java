 ...
 * @author Taejin Koo
 */
@Component("statReceiverProperties")
public class StatReceiverProperties implements DataReceiverGroupProperties {
    ...
    @Bean
    public ExecutorProperties statExecutorConfiguration() {
