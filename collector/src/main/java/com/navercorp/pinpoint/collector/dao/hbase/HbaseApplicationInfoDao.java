...
public class HbaseApplicationInfoDao implements ApplicationInfoDao {
    ...
    public ApplicationId getApplicationId(ApplicationSelector application) {
        ...
        byte[] rowKey = encodeSelectorRowKey(application);
    ...
    public ApplicationId putApplicationIdIfAbsent(ApplicationInfo application) {
        ...
        ApplicationId applicationId = getApplicationId(new ApplicationSelector(application.serviceId(), application.name()));
    ...
    private static byte[] encodeSelectorRowKey(ApplicationSelector tuple) {
        return HashUtils.hashBytes(tuple.toBytes()).asBytes();
    }
