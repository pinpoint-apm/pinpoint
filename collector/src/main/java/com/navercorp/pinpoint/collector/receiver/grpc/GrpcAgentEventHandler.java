...
@Service
public class GrpcAgentEventHandler {

    @Autowired
    private AgentEventService agentEventService;

    @Async("agentEventWorker")
    public void handleEvent(final String agentId, final long startTimestamp, final long eventTimestamp, final AgentEventType agentEventType) {

        final AgentEventBo agentEventBo = newAgentEventBo(agentId, startTimestamp, eventTimestamp, agentEventType);
