...
public class ApplicationUidServiceImpl implements ApplicationUidService {
    ...
    public ApplicationUid getOrCreateApplicationId(ServiceUid serviceUid, String applicationName) {
        ...
        StopWatch watch = new StopWatch("getOrCreateApplicationId " + serviceUid.getUid() + ":" + applicationName);
        watch.start("getApplicationId 1");
        ...
        watch.start("tryInsertApplicationId");
        ...
        watch.start("getApplicationId 2");
