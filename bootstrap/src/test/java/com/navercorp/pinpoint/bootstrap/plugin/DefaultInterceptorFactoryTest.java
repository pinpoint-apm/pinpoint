...
import com.navercorp.pinpoint.bootstrap.plugin.editor.DefaultInterceptorFactory;
...
public class DefaultInterceptorFactoryTest {
    ...
    public void test0() throws Exception {
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(pluginContext, instrumentor, traceContext, "com.navercorp.pinpoint.bootstrap.plugin.TestInterceptors$TestInterceptor0", null);
    ...
    public void test1() throws Exception {
        ...
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(pluginContext, instrumentor, traceContext, "com.navercorp.pinpoint.bootstrap.plugin.TestInterceptors$TestInterceptor0", args);
        Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(), aClass, aMethod);
    ...
    public void test3() throws Exception {
        ...
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(pluginContext, instrumentor, traceContext, "com.navercorp.pinpoint.bootstrap.plugin.TestInterceptors$TestInterceptor1", args);
        Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(), aClass, aMethod);
    ...
    public void test7() throws Exception {
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(pluginContext, instrumentor, traceContext, "com.navercorp.pinpoint.bootstrap.plugin.TestInterceptors$TestInterceptor1", null);
        factory.getInterceptor(getClass().getClassLoader(), aClass, aMethod);
    }
    ...
    public void test9() throws Exception {
        ...
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(pluginContext, instrumentor, traceContext, "com.navercorp.pinpoint.bootstrap.plugin.TestInterceptors$TestInterceptor2", args);
        Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(), aClass, aMethod);
    ...
    public void test12() throws Exception {
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(pluginContext, instrumentor, traceContext, "com.navercorp.pinpoint.bootstrap.plugin.TestInterceptors$TestInterceptor2", null);
        Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(), aClass, aMethod);
