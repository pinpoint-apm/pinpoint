...
public class HbaseTableTest {
    ...
    public void agentInfoInfoTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("Info"), agentinfoInfo.getName());
        Assert.assertEquals("AgentInfo", agentinfoInfo.getTable().getName());
        Assert.assertArrayEquals(Bytes.toBytes("m"), agentinfoInfo.QUALIFIER_SERVER_META_DATA);
        Assert.assertArrayEquals(Bytes.toBytes("i"), agentinfoInfo.QUALIFIER_IDENTIFIER);
        Assert.assertArrayEquals(Bytes.toBytes("j"), agentinfoInfo.QUALIFIER_JVM);
    }

    @Test
    public void agentEventEventsTest() {
        HbaseColumnFamily agentEventEvents = HbaseColumnFamily.AGENT_EVENT_EVENTS;
        Assert.assertArrayEquals(Bytes.toBytes("E"), agentEventEvents.getName());
    ...
    public void agentLifecycleStatusTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("S"), agentLifecycleStatus.getName());
        Assert.assertEquals("AgentLifeCycle", agentLifecycleStatus.getTable().getName());
        Assert.assertArrayEquals(Bytes.toBytes("states"), agentLifecycleStatus.QUALIFIER_STATES);
    }
    ...
    public void agentStatStatisticsTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("S"), agentStatStatistics.getName());
    ...
    public void apiMetadataApiTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("Api"), apiMetadataApi.getName());
        Assert.assertEquals("ApiMetaData", apiMetadataApi.getTable().getName());
        Assert.assertArrayEquals(Bytes.toBytes("P_api_signature"), apiMetadataApi.QUALIFIER_SIGNATURE);
    }
    ...
    public void applicationIndexAgentsTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("Agents"), applicationIndexAgents.getName());
    ...
    public void applicationStatStatisticsTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("S"), applicationStatStatistics.getName());
    ...
    public void applicationTraceIndexTraceTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("I"), applicationTraceIndexTrace.getName());
    ...
    public void hostApplicationMapVer2MapTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("M"), hostApplicationMapVer2Map.getName());
    ...
    public void mapStatisticsCalleeVer2CounterTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("C"), mapStatisticsCalleeVer2Counter.getName());
    ...
    public void mapStatisticsCallerVer2CounterTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("C"), mapStatisticsCallerVer2Counter.getName());
    ...
    public void mapStatisticsSelfVer2CounterTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("C"), mapStatisticsSelfVer2Counter.getName());
    ...
    public void sqlMetadataVer2SqlTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("Sql"), sqlMetadataVer2Sql.getName());
        Assert.assertEquals("SqlMetaData_Ver2", sqlMetadataVer2Sql.getTable().getName());
        Assert.assertArrayEquals(Bytes.toBytes("P_sql_statement"), sqlMetadataVer2Sql.QUALIFIER_SQLSTATEMENT);
    }
    ...
    public void stringMetadataStrTest() {
        ...
        Assert.assertArrayEquals(Bytes.toBytes("Str"), stringMetadataStr.getName());
        Assert.assertEquals("StringMetaData", stringMetadataStr.getTable().getName());
        Assert.assertArrayEquals(Bytes.toBytes("P_string"), stringMetadataStr.QUALIFIER_STRING);
    }

    @Test
    public void traceV2SpanTest() {
        HbaseColumnFamily traceV2Span = HbaseColumnFamily.TRACE_V2_SPAN;
        Assert.assertArrayEquals(Bytes.toBytes("S"), traceV2Span.getName());
