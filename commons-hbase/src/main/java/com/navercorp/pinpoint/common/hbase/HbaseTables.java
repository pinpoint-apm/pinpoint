...
public class HbaseTables {
    ...
    public static final HbaseColumnFamily APPLICATION = new HbaseColumnFamily(HbaseTableV2.APPLICATION, Bytes.toBytes("A"));
    ...
    public static final HbaseColumnFamily APPLICATION_TRACE_INDEX_TRACE_V2 = new HbaseColumnFamily(HbaseTableV3.APPLICATION_TRACE_INDEX_V2, Bytes.toBytes("I"));
    public static final HbaseColumnFamily APPLICATION_TRACE_INDEX_META_V2 = new HbaseColumnFamily(HbaseTableV3.APPLICATION_TRACE_INDEX_V2, Bytes.toBytes("M"));
